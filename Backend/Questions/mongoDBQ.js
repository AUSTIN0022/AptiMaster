const mongoDBQuestions = [
    ...
    // Data Validation
    {
        ...
        "questionText": "What MongoDB feature allows you to enforce document structure?",
        "options": ["Schema Validator", "Document Enforcer", "Structure Rules", "JSON Schema"],
        "correctOptionIndex": 3,
        "correctOptionText": "JSON Schema",
        "difficulty": "easy",
        "explanation": "MongoDB uses JSON Schema validation to enforce document structure and data types within a collection.",
        "hint": "MongoDB adopted an industry standard for describing document shape and content."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "Which command is used to add validation rules to an existing collection?",
        "options": ["db.createValidator()", "db.collection.createValidator()", "db.collection.collMod()", "db.validator.create()"],
        "correctOptionIndex": 2,
        "correctOptionText": "db.collection.collMod()",
        "difficulty": "medium",
        "explanation": "The collMod command modifies collection behavior, including adding or changing validation rules for an existing collection.",
        "hint": "This command allows you to modify (mod) collection (coll) properties."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "What validation action occurs when a document fails validation during an update?",
        "options": ["The database shuts down", "The document is automatically fixed", "The operation is rejected or warnings are logged", "The document is marked as invalid"],
        "correctOptionIndex": 2,
        "correctOptionText": "The operation is rejected or warnings are logged",
        "difficulty": "easy",
        "explanation": "When a document fails validation, MongoDB either rejects the operation or logs warnings, depending on the validationAction setting.",
        "hint": "MongoDB gives you two choices on how to handle validation failures."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "Which MongoDB version first introduced document validation?",
        "options": ["MongoDB 3.0", "MongoDB 3.2", "MongoDB 4.0", "MongoDB 4.2"],
        "correctOptionIndex": 1,
        "correctOptionText": "MongoDB 3.2",
        "difficulty": "medium",
        "explanation": "Document validation was introduced in MongoDB 3.2, providing a way to enforce rules on document structure.",
        "hint": "It was introduced in a version between 3.0 and 4.0."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "What does the validationLevel option control?",
        "options": ["The strictness of type checking", "Which documents undergo validation", "The number of validation rules allowed", "The validation error verbosity"],
        "correctOptionIndex": 1,
        "correctOptionText": "Which documents undergo validation",
        "difficulty": "medium",
        "explanation": "validationLevel determines which documents the validator checks - all documents during updates, only non-compliant documents, or all documents including previously existing ones.",
        "hint": "This controls whether all documents or just some go through the validation process."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "Which of these is NOT a valid validationAction value?",
        "options": ["error", "warn", "ignore", "log"],
        "correctOptionIndex": 2,
        "correctOptionText": "ignore",
        "difficulty": "medium",
        "explanation": "The valid validationAction values are 'error' (reject invalid documents) and 'warn' (allow but log warnings). 'ignore' is not a valid option.",
        "hint": "MongoDB offers two ways to handle validation failures - rejecting or accepting with a warning."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "Which validation level option would validate all documents during inserts and updates?",
        "options": ["strict", "moderate", "all", "full"],
        "correctOptionIndex": 0,
        "correctOptionText": "strict",
        "difficulty": "medium",
        "explanation": "The 'strict' validation level applies validation rules to all inserts and all updates.",
        "hint": "This is the most rigorous validation level option."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "What is the default validationAction in MongoDB?",
        "options": ["warn", "error", "ignore", "log"],
        "correctOptionIndex": 1,
        "correctOptionText": "error",
        "difficulty": "easy",
        "explanation": "By default, MongoDB uses 'error' as the validationAction, which rejects any document that violates the validation rules.",
        "hint": "By default, MongoDB prioritizes data integrity over operation success."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "What object must be included in the validator document when creating a collection with validation?",
        "options": ["$schema", "$validator", "$jsonSchema", "$rules"],
        "correctOptionIndex": 2,
        "correctOptionText": "$jsonSchema",
        "difficulty": "medium",
        "explanation": "The $jsonSchema operator is used to specify JSON Schema validation rules within the validator document.",
        "hint": "This operator indicates you're using JSON Schema for validation rules."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "Which validation level skips validation for updates to existing documents that do not already meet the validation criteria?",
        "options": ["strict", "moderate", "lenient", "minimal"],
        "correctOptionIndex": 1,
        "correctOptionText": "moderate",
        "difficulty": "hard",
        "explanation": "The 'moderate' validation level applies validation rules to inserts and to updates of valid documents, but not to updates of existing invalid documents.",
        "hint": "This option balances between strict validation and allowing updates to non-compliant documents."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "What is the primary advantage of using JSON Schema validation over query expression validators?",
        "options": ["Performance", "More expressive validation capabilities", "Simpler syntax", "Better error reporting"],
        "correctOptionIndex": 1,
        "correctOptionText": "More expressive validation capabilities",
        "difficulty": "medium",
        "explanation": "JSON Schema offers more expressive validation capabilities including data type validation, string patterns, numeric ranges, and required fields that are more powerful than query expression validators.",
        "hint": "JSON Schema gives you more ways to describe and restrict your data than query expressions."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "Which keyword in JSON Schema is used to specify that a field must be present in the document?",
        "options": ["mandatory", "required", "necessary", "essential"],
        "correctOptionIndex": 1,
        "correctOptionText": "required",
        "difficulty": "easy",
        "explanation": "In JSON Schema, the 'required' keyword specifies an array of fields that must be present in the document.",
        "hint": "This common validation term describes fields that cannot be omitted."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "How do you specify that a field must be of numeric type in JSON Schema validation?",
        "options": ["type: 'numeric'", "type: 'number'", "type: 'integer'", "type: 'decimal'"],
        "correctOptionIndex": 1,
        "correctOptionText": "type: 'number'",
        "difficulty": "easy",
        "explanation": "In JSON Schema, you specify that a field must be numeric by setting 'type: \"number\"' for any numeric value, or 'type: \"integer\"' specifically for integer values.",
        "hint": "JSON Schema follows JavaScript type conventions for numeric values."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "Which of the following is NOT a valid JSON Schema type in MongoDB?",
        "options": ["string", "boolean", "decimal", "object"],
        "correctOptionIndex": 2,
        "correctOptionText": "decimal",
        "difficulty": "medium",
        "explanation": "Valid JSON Schema types in MongoDB include string, boolean, object, array, number, integer, and null. 'decimal' is not a valid type (though MongoDB has a Decimal128 BSON type).",
        "hint": "JSON Schema types follow JavaScript type conventions."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "Which JSON Schema keyword is used to specify a pattern that a string must match?",
        "options": ["match", "regex", "pattern", "format"],
        "correctOptionIndex": 2,
        "correctOptionText": "pattern",
        "difficulty": "medium",
        "explanation": "The 'pattern' keyword in JSON Schema specifies a regular expression that a string value must match.",
        "hint": "This keyword is used with a regular expression to validate string formats."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "What does the 'maximum' keyword in JSON Schema validation define?",
        "options": ["Maximum length of an array", "Maximum size of the document", "Maximum numeric value allowed", "Maximum number of properties"],
        "correctOptionIndex": 2,
        "correctOptionText": "Maximum numeric value allowed",
        "difficulty": "easy",
        "explanation": "The 'maximum' keyword defines the maximum numeric value that a number field can have, inclusive by default.",
        "hint": "This applies to number fields and puts an upper bound on acceptable values."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "To specify that a document must contain either a 'phone' or 'email' field, which JSON Schema keyword would you use?",
        "options": ["anyOf", "oneOf", "allOf", "conditional"],
        "correctOptionIndex": 0,
        "correctOptionText": "anyOf",
        "difficulty": "hard",
        "explanation": "The 'anyOf' keyword specifies that a valid document must satisfy at least one of the given schemas. In this case, it would require either a 'phone' or 'email' field (or both).",
        "hint": "This keyword allows for multiple valid schemas where at least one must match."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "Which JSON Schema validation keyword ensures that an array field has no duplicate items?",
        "options": ["noDuplicates", "uniqueItems", "distinct", "setItems"],
        "correctOptionIndex": 1,
        "correctOptionText": "uniqueItems",
        "difficulty": "medium",
        "explanation": "The 'uniqueItems' keyword, when set to true, ensures that all items in an array are unique.",
        "hint": "This boolean property enforces set-like behavior on arrays."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "What happens to existing invalid documents when you add validation to a collection?",
        "options": ["They are automatically removed", "They are updated to meet validation", "They remain in the collection", "They are moved to a special collection"],
        "correctOptionIndex": 2,
        "correctOptionText": "They remain in the collection",
        "difficulty": "easy",
        "explanation": "When you add validation to a collection, existing documents that violate the rules remain in the collection. Validation only affects new inserts and updates.",
        "hint": "Adding validation is not retroactive for existing data."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "Which command would you use to find documents in a collection that violate validation rules?",
        "options": ["db.collection.validate()", "db.collection.findInvalid()", "db.collection.find() with special query", "It's not possible to query for invalid documents"],
        "correctOptionIndex": 2,
        "correctOptionText": "db.collection.find() with special query",
        "difficulty": "hard",
        "explanation": "To find invalid documents, you must create a query that negates your validation rules and use it with db.collection.find(). There's no built-in command to find invalid documents directly.",
        "hint": "You need to manually construct a query that matches documents failing your validation criteria."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "What's the effect of using 'additionalProperties: false' in a JSON Schema validator?",
        "options": ["Prevents adding new collections", "Rejects documents with fields not defined in the schema", "Disables document updates", "Makes all properties optional"],
        "correctOptionIndex": 1,
        "correctOptionText": "Rejects documents with fields not defined in the schema",
        "difficulty": "medium",
        "explanation": "Setting 'additionalProperties: false' in a JSON Schema validator rejects documents that contain fields not explicitly defined in the schema, enforcing a strict document structure.",
        "hint": "This setting controls whether fields beyond those you've explicitly defined are allowed."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "How can you make MongoDB validate only certain fields while ignoring others?",
        "options": ["Use 'ignoredFields' array", "Set 'additionalProperties: true'", "Use partial validation option", "Define only the fields you want to validate"],
        "correctOptionIndex": 3,
        "correctOptionText": "Define only the fields you want to validate",
        "difficulty": "medium",
        "explanation": "To validate only certain fields, define only those fields in your schema and set 'additionalProperties: true' (which is the default). This validates the specified fields while allowing any other fields without validation.",
        "hint": "MongoDB only validates what you explicitly define in your schema if you don't restrict additional properties."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "What is the purpose of the 'bsonType' keyword in MongoDB's JSON Schema implementation?",
        "options": ["To convert BSON to JSON", "To validate against MongoDB-specific data types", "To optimize BSON storage", "To define binary data formats"],
        "correctOptionIndex": 1,
        "correctOptionText": "To validate against MongoDB-specific data types",
        "difficulty": "hard",
        "explanation": "The 'bsonType' keyword is MongoDB's extension to JSON Schema that allows validation against MongoDB-specific BSON types like ObjectId, Decimal128, or ISODate that aren't in standard JSON Schema.",
        "hint": "This MongoDB-specific extension handles data types unique to MongoDB's document model."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "When defining a JSON Schema validator with sub-documents, which property ensures the sub-document follows a specific schema?",
        "options": ["subSchema", "childSchema", "properties", "subdocument"],
        "correctOptionIndex": 2,
        "correctOptionText": "properties",
        "difficulty": "medium",
        "explanation": "For object fields with nested documents, the 'properties' field defines the schema for the sub-document's fields and their validation rules.",
        "hint": "This keyword defines the structure and validation rules for fields within a nested object."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "What role does the 'enum' keyword play in MongoDB validation?",
        "options": ["Defines enumerated collection types", "Restricts a field to a set of predefined values", "Creates enumerated indexes", "Defines sequential field values"],
        "correctOptionIndex": 1,
        "correctOptionText": "Restricts a field to a set of predefined values",
        "difficulty": "easy",
        "explanation": "The 'enum' keyword restricts a field to only accept values from a specified array of allowed values, creating a closed set of valid options.",
        "hint": "This keyword lets you define a limited set of acceptable values for a field."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "Which of the following is NOT a standard JSON Schema numeric validation keyword in MongoDB?",
        "options": ["minimum", "maximum", "exclusiveMinimum", "average"],
        "correctOptionIndex": 3,
        "correctOptionText": "average",
        "difficulty": "medium",
        "explanation": "Standard JSON Schema numeric validation keywords include 'minimum', 'maximum', 'exclusiveMinimum', and 'exclusiveMaximum'. 'average' is not a validation keyword.",
        "hint": "Three of these keywords define boundaries for numeric values."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "What happens if you try to create a collection with an invalid JSON Schema validator?",
        "options": ["The collection is created without validation", "MongoDB automatically fixes the schema", "The command fails with an error", "A warning is logged but the operation succeeds"],
        "correctOptionIndex": 2,
        "correctOptionText": "The command fails with an error",
        "difficulty": "easy",
        "explanation": "If you attempt to create a collection with an invalid JSON Schema validator, MongoDB rejects the operation with an error message indicating the issue with the schema.",
        "hint": "MongoDB checks the syntax of your validator before applying it."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "Which MongoDB driver method ignores validation rules when inserting documents?",
        "options": ["insertWithoutValidation()", "bypassValidation()", "insertIgnoreValidation()", "There is no such method"],
        "correctOptionIndex": 3,
        "correctOptionText": "There is no such method",
        "difficulty": "hard",
        "explanation": "There's no standard driver method to bypass validation. Instead, you must set the 'bypassDocumentValidation: true' option in write operations like insertMany() or bulkWrite() to skip validation rules.",
        "hint": "Rather than a dedicated method, this functionality is provided through an option on existing methods."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "What is the correct syntax to create a collection with validation rules in MongoDB?",
        "options": [
        "db.createCollection('name', { validate: {...} })",
        "db.createCollection('name', { validation: {...} })",
        "db.createCollection('name', { validator: {...} })",
        "db.createCollection('name', { schema: {...} })"
        ],
        "correctOptionIndex": 2,
        "correctOptionText": "db.createCollection('name', { validator: {...} })",
        "difficulty": "easy",
        "explanation": "The correct syntax uses the 'validator' option in the createCollection() method to specify validation rules for the collection.",
        "hint": "This option takes a document that can contain JSON Schema or query operators."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Data Validation",
        "questionText": "How can you require that a string field contain an email address in MongoDB validation?",
        "options": [
        "type: 'email'",
        "format: 'email'",
        "pattern: regex for email",
        "MongoDB doesn't support email validation"
        ],
        "correctOptionIndex": 2,
        "correctOptionText": "pattern: regex for email",
        "difficulty": "hard",
        "explanation": "MongoDB doesn't directly support the 'format' keyword for email validation. Instead, you must use the 'pattern' keyword with a regular expression that matches email patterns.",
        "hint": "You need to use a regular expression to validate specific string formats in MongoDB."
    },
    ...
    // MongoDB Atlas
    {
        ...
        "questionText": "What is MongoDB Atlas?",
        "options": ["A NoSQL database language", "MongoDB's cloud database service", "A MongoDB visualization tool", "An open-source MongoDB fork"],
        "correctOptionIndex": 1,
        "correctOptionText": "MongoDB's cloud database service",
        "difficulty": "easy",
        "explanation": "MongoDB Atlas is the official cloud database service provided by MongoDB, Inc. It offers a fully-managed database solution with automated deployment, scaling, and operations.",
        "hint": "Think about what service MongoDB officially offers in the cloud."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "Which cloud providers can host MongoDB Atlas clusters?",
        "options": ["Only AWS", "Only Google Cloud", "AWS, Google Cloud, and Azure", "Any cloud provider"],
        "correctOptionIndex": 2,
        "correctOptionText": "AWS, Google Cloud, and Azure",
        "difficulty": "easy",
        "explanation": "MongoDB Atlas can be deployed on the three major cloud providers: Amazon Web Services (AWS), Google Cloud Platform (GCP), and Microsoft Azure.",
        "hint": "Think about the major public cloud providers in the market."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is the smallest Atlas cluster tier available?",
        "options": ["M0 (Free Tier)", "M2", "M10", "S0"],
        "correctOptionIndex": 0,
        "correctOptionText": "M0 (Free Tier)",
        "difficulty": "medium",
        "explanation": "The M0 free tier is the smallest cluster tier available in MongoDB Atlas, offering a shared environment with 512MB storage for learning and small applications.",
        "hint": "Atlas offers a free tier for developers to get started."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "Which of the following is NOT a feature of MongoDB Atlas?",
        "options": ["Automated backups", "Performance Advisor", "On-premises deployment option", "Database auditing"],
        "correctOptionIndex": 2,
        "correctOptionText": "On-premises deployment option",
        "difficulty": "medium",
        "explanation": "MongoDB Atlas is exclusively a cloud-based service and does not offer on-premises deployment. For on-premises MongoDB, you would use MongoDB Enterprise or Community Edition.",
        "hint": "Atlas is specifically designed as a cloud service, not for local installation."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What security feature automatically encrypts data in MongoDB Atlas?",
        "options": ["Network Peering", "IP Whitelist", "Atlas Encryption At Rest", "Two-Factor Authentication"],
        "correctOptionIndex": 2,
        "correctOptionText": "Atlas Encryption At Rest",
        "difficulty": "medium",
        "explanation": "Atlas Encryption At Rest automatically encrypts data files and backups, protecting stored data without requiring any application changes.",
        "hint": "This security feature protects data when it's stored but not being processed."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "How does MongoDB Atlas handle database backups?",
        "options": ["Manual backups only", "No backup capabilities", "Automated scheduled backups", "Third-party backup tools only"],
        "correctOptionIndex": 2,
        "correctOptionText": "Automated scheduled backups",
        "difficulty": "easy",
        "explanation": "MongoDB Atlas provides automated, scheduled backups with point-in-time recovery. Backup frequency and retention policy depend on the cluster tier.",
        "hint": "Atlas handles this critical operational task without manual intervention."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is Atlas Search?",
        "options": ["A search engine for MongoDB documentation", "Full-text search capability for Atlas clusters", "A tool to find Atlas clusters", "A tool to search for MongoDB experts"],
        "correctOptionIndex": 1,
        "correctOptionText": "Full-text search capability for Atlas clusters",
        "difficulty": "medium",
        "explanation": "Atlas Search is a full-text search feature built into MongoDB Atlas that provides advanced search functionality like text, fuzzy, and compound searches without requiring a separate search engine.",
        "hint": "This feature enhances the querying capabilities of your Atlas databases."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What tool in MongoDB Atlas allows you to analyze query performance?",
        "options": ["Atlas Logger", "Performance Advisor", "Query Optimizer", "Execution Analyzer"],
        "correctOptionIndex": 1,
        "correctOptionText": "Performance Advisor",
        "difficulty": "medium",
        "explanation": "The Performance Advisor in MongoDB Atlas monitors query performance and provides index recommendations to optimize slow-running operations.",
        "hint": "This Atlas tool suggests ways to improve query speed."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is the minimum number of nodes in a standard MongoDB Atlas cluster?",
        "options": ["1", "2", "3", "5"],
        "correctOptionIndex": 2,
        "correctOptionText": "3",
        "difficulty": "medium",
        "explanation": "Standard MongoDB Atlas clusters (M10+) are replica sets with a minimum of 3 nodes (1 primary and 2 secondaries) to provide high availability and data redundancy.",
        "hint": "This follows MongoDB's recommended replica set configuration for production."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is Atlas Data Federation?",
        "options": ["A tool to migrate data between databases", "A feature to query data across multiple clusters and storage locations", "A system to replicate data globally", "A data encryption service"],
        "correctOptionIndex": 1,
        "correctOptionText": "A feature to query data across multiple clusters and storage locations",
        "difficulty": "hard",
        "explanation": "Atlas Data Federation (formerly Atlas Data Lake) allows querying data across MongoDB clusters and cloud object storage like S3 or Google Cloud Storage, without moving the data.",
        "hint": "This feature lets you work with distributed data sources as if they were a single database."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is the purpose of the MongoDB Atlas API?",
        "options": ["To query database records", "To programmatically manage Atlas resources", "To connect mobile apps directly to Atlas", "To authenticate database users"],
        "correctOptionIndex": 1,
        "correctOptionText": "To programmatically manage Atlas resources",
        "difficulty": "medium",
        "explanation": "The MongoDB Atlas API allows programmatic management of Atlas resources like clusters, users, and alerts, enabling infrastructure automation and DevOps workflows.",
        "hint": "This allows you to manage your Atlas resources through code rather than the UI."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "Which Atlas feature helps implement CI/CD practices for database changes?",
        "options": ["Atlas CI Engine", "Database Triggers", "Atlas GitOps", "Atlas Database Testing"],
        "correctOptionIndex": 2,
        "correctOptionText": "Atlas GitOps",
        "difficulty": "hard",
        "explanation": "Atlas GitOps allows teams to implement GitOps workflows for database infrastructure, enabling versioning, review, and automation of Atlas resource configurations as code.",
        "hint": "This feature combines Git-based workflows with operations for Atlas resources."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is an Atlas organization?",
        "options": ["A MongoDB employee group", "A database user group", "The highest-level grouping entity that contains projects", "A collection of related databases"],
        "correctOptionIndex": 2,
        "correctOptionText": "The highest-level grouping entity that contains projects",
        "difficulty": "easy",
        "explanation": "An Atlas organization is the top-level grouping entity that contains projects. Organizations typically represent companies or teams and can have multiple projects underneath them.",
        "hint": "This is the top-level administrative unit in the Atlas hierarchy."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What feature enables MongoDB Atlas to alert you when database metrics exceed thresholds?",
        "options": ["Atlas Monitoring", "Alert Settings", "Metric Tracking", "Performance Dashboard"],
        "correctOptionIndex": 1,
        "correctOptionText": "Alert Settings",
        "difficulty": "easy",
        "explanation": "Atlas Alert Settings allow you to configure notifications when metrics like CPU usage, connections, or operation time exceed defined thresholds, ensuring timely response to potential issues.",
        "hint": "This feature sends notifications when conditions you specify are met."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "How can you connect a MongoDB client securely to an Atlas cluster?",
        "options": ["Only through VPN", "Using connection strings with credentials", "Only from the same cloud provider", "Only through MongoDB Compass"],
        "correctOptionIndex": 1,
        "correctOptionText": "Using connection strings with credentials",
        "difficulty": "easy",
        "explanation": "Clients connect securely to Atlas clusters using connection strings that include authentication credentials and TLS/SSL encryption, combined with IP access lists for network security.",
        "hint": "This standard method includes the necessary authentication and connection information."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is MongoDB Atlas Online Archive?",
        "options": ["A historical record of configuration changes", "A documentation repository", "A feature that automatically moves infrequently accessed data to cost-effective storage", "A backup service for archived databases"],
        "correctOptionIndex": 2,
        "correctOptionText": "A feature that automatically moves infrequently accessed data to cost-effective storage",
        "difficulty": "medium",
        "explanation": "Atlas Online Archive automatically moves infrequently accessed data from your cluster to cost-effective cloud object storage based on criteria you define, while keeping it queryable.",
        "hint": "This feature implements a tiered storage approach for cold data."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What type of MongoDB Atlas feature are Triggers?",
        "options": ["Monitoring tools", "Security controls", "Serverless functions", "Network configurations"],
        "correctOptionIndex": 2,
        "correctOptionText": "Serverless functions",
        "difficulty": "medium",
        "explanation": "Atlas Triggers are serverless functions that execute in response to database events or schedules, enabling automated reactions to data changes without managing infrastructure.",
        "hint": "These functions run automatically in response to events without requiring server management."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is the primary purpose of Atlas App Services (formerly Realm)?",
        "options": ["To manage database backups", "To provide backend services for application development", "To monitor database performance", "To encrypt database traffic"],
        "correctOptionIndex": 1,
        "correctOptionText": "To provide backend services for application development",
        "difficulty": "medium",
        "explanation": "Atlas App Services provides a suite of backend services for application development, including authentication, functions, triggers, and data access, simplifying backend development for MongoDB applications.",
        "hint": "This set of services helps developers build applications faster without building common backend components."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is MongoDB Atlas Charts?",
        "options": ["A pricing calculator", "A visualization tool for MongoDB data", "A database schema designer", "A monitoring dashboard"],
        "correctOptionIndex": 1,
        "correctOptionText": "A visualization tool for MongoDB data",
        "difficulty": "easy",
        "explanation": "MongoDB Atlas Charts is a data visualization tool that allows you to create, share, and embed charts and dashboards using your MongoDB data without ETL processes.",
        "hint": "This tool helps you create visual representations of your database information."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "How can you restrict which IP addresses can connect to your MongoDB Atlas cluster?",
        "options": ["Using database user permissions", "With Network Access Lists", "Through database auditing", "With Atlas VPC"],
        "correctOptionIndex": 1,
        "correctOptionText": "With Network Access Lists",
        "difficulty": "easy",
        "explanation": "Atlas Network Access Lists (IP Whitelists) let you control which IP addresses or CIDR blocks can connect to your cluster, adding an essential layer of network security.",
        "hint": "This security feature controls access at the network level."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is the difference between an M10 and M30 Atlas cluster?",
        "options": ["Number of databases allowed", "Hardware capacity (RAM, CPU, and storage)", "Geographic regions available", "Maximum number of connections"],
        "correctOptionIndex": 1,
        "correctOptionText": "Hardware capacity (RAM, CPU, and storage)",
        "difficulty": "medium",
        "explanation": "The primary difference between M10 and M30 Atlas clusters is their hardware capacity. M30 provides more RAM, CPU, and storage capacity than M10, accommodating larger workloads.",
        "hint": "These tier designations primarily indicate the resources allocated to the cluster."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is a Private Endpoint in MongoDB Atlas?",
        "options": ["A dedicated database instance", "A secure connection point between VPC and Atlas without public internet", "A private collection within a database", "An internal MongoDB user"],
        "correctOptionIndex": 1,
        "correctOptionText": "A secure connection point between VPC and Atlas without public internet",
        "difficulty": "hard",
        "explanation": "A Private Endpoint creates a secure, private connection between your VPC and Atlas clusters without traversing the public internet, enhancing security for sensitive workloads.",
        "hint": "This networking feature allows for secure connectivity without exposure to the public internet."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "How does MongoDB Atlas implement high availability?",
        "options": ["Through multiple application servers", "By using replica sets across availability zones", "With load balancers", "By caching data locally"],
        "correctOptionIndex": 1,
        "correctOptionText": "By using replica sets across availability zones",
        "difficulty": "medium",
        "explanation": "MongoDB Atlas implements high availability by deploying replica sets with nodes distributed across different availability zones within a region, ensuring service continuity even if an entire zone fails.",
        "hint": "This architecture distributes database copies geographically within a region."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is the purpose of the Atlas Data Explorer?",
        "options": ["To monitor database performance", "To browse and modify your data", "To explore pricing options", "To visualize network traffic"],
        "correctOptionIndex": 1,
        "correctOptionText": "To browse and modify your data",
        "difficulty": "easy",
        "explanation": "The Atlas Data Explorer provides a web-based interface to browse, query, and modify your database data, including viewing documents, running aggregations, and managing indexes.",
        "hint": "This UI tool lets you interact with the actual content of your databases."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is a Global Cluster in MongoDB Atlas?",
        "options": ["A cluster with global admin privileges", "A cluster that spans multiple cloud providers", "A sharded cluster that distributes data by geographic location", "The largest available cluster size"],
        "correctOptionIndex": 2,
        "correctOptionText": "A sharded cluster that distributes data by geographic location",
        "difficulty": "hard",
        "explanation": "A Global Cluster is a specialized sharded cluster that distributes data by geographic location, allowing data to be kept close to users in specific regions for lower latency and compliance with data residency requirements.",
        "hint": "This configuration optimizes data placement based on geography."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "Which of these operations can be performed through the MongoDB Atlas UI?",
        "options": ["Creating custom MongoDB server builds", "Modifying the MongoDB source code", "Creating and restoring database backups", "Directly editing WiredTiger cache settings"],
        "correctOptionIndex": 2,
        "correctOptionText": "Creating and restoring database backups",
        "difficulty": "easy",
        "explanation": "The MongoDB Atlas UI allows you to create on-demand backups and restore from existing backups, making point-in-time recovery operations accessible without command-line tools.",
        "hint": "This important operational task is available through the web interface."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is the purpose of the MongoDB Atlas Activity Feed?",
        "options": ["To track database queries", "To monitor user logins", "To view project activity history", "To show database growth trends"],
        "correctOptionIndex": 2,
        "correctOptionText": "To view project activity history",
        "difficulty": "medium",
        "explanation": "The Activity Feed in MongoDB Atlas provides a chronological record of actions performed in your project, including who made changes to clusters, users, and other settings.",
        "hint": "This feature helps track what administrative changes have been made and by whom."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What MongoDB Atlas feature allows you to maintain continuous backups with point-in-time recovery?",
        "options": ["Scheduled Snapshots", "Continuous Backup", "Incremental Backup", "Live Migration"],
        "correctOptionIndex": 1,
        "correctOptionText": "Continuous Backup",
        "difficulty": "medium",
        "explanation": "Atlas Continuous Backup captures database changes as they occur, enabling restoration to any point in time within the retention window, rather than just to specific snapshot times.",
        "hint": "This backup method allows recovery to a specific moment rather than just pre-scheduled points."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What is the Realm Sync feature in MongoDB Atlas App Services?",
        "options": ["A tool to synchronize schema changes", "A feature to sync data between Atlas clusters", "A capability that synchronizes data between client devices and the database", "A backup synchronization tool"],
        "correctOptionIndex": 2,
        "correctOptionText": "A capability that synchronizes data between client devices and the database",
        "difficulty": "hard",
        "explanation": "Realm Sync (now part of Atlas Device Sync) automatically synchronizes data between client devices and MongoDB Atlas, handling offline operations and conflict resolution for mobile and web applications.",
        "hint": "This feature is particularly useful for mobile apps that need to work offline."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "How can you connect MongoDB Atlas to BI tools like Tableau or Power BI?",
        "options": ["Only through custom API development", "It's not possible to connect Atlas to BI tools", "Using the MongoDB Connector for BI", "Only through Atlas Charts"],
        "correctOptionIndex": 2,
        "correctOptionText": "Using the MongoDB Connector for BI",
        "difficulty": "medium",
        "explanation": "The MongoDB Connector for BI allows you to connect Atlas to business intelligence tools by presenting MongoDB data as relational tables that can be queried with SQL.",
        "hint": "This specialized connector bridges the gap between MongoDB's document model and SQL-based analytics tools."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "MongoDB Atlas",
        "questionText": "What feature would you use to monitor slow-running queries in MongoDB Atlas?",
        "options": ["Database Profiler", "Real-Time Performance Panel", "Slow Query Analyzer", "Profiler Log Viewer"],
        "correctOptionIndex": 0,
        "correctOptionText": "Database Profiler",
        "difficulty": "hard",
        "explanation": "The MongoDB Atlas Database Profiler captures and displays detailed information about slow-running operations, helping identify and optimize performance bottlenecks.",
        "hint": "This monitoring tool specifically focuses on operations that take longer than expected."
    },
    ...
    // Replication
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What is the primary purpose of MongoDB replication?",
        "options": ["To increase write performance", "To provide high availability", "To distribute data geographically", "To enforce schema validation"],
        "correctOptionIndex": 1,
        "correctOptionText": "To provide high availability",
        "difficulty": "easy",
        "explanation": "The primary purpose of MongoDB replication is to provide high availability by maintaining multiple copies of data across different database servers, ensuring that if one server fails, data can still be accessed from another server.",
        "hint": "Think about what happens when a server fails in a replicated environment."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What is the minimum number of members required for a MongoDB replica set?",
        "options": ["1", "2", "3", "5"],
        "correctOptionIndex": 2,
        "correctOptionText": "3",
        "difficulty": "easy",
        "explanation": "A MongoDB replica set requires a minimum of 3 members for proper operation. This typically includes a primary, a secondary, and an arbiter (or another secondary).",
        "hint": "The minimum configuration needs to support failover and majority voting."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "In a MongoDB replica set, which member accepts write operations?",
        "options": ["All members", "Primary only", "Secondary only", "Arbiter only"],
        "correctOptionIndex": 1,
        "correctOptionText": "Primary only",
        "difficulty": "easy",
        "explanation": "In a MongoDB replica set, only the primary member accepts write operations. All write operations are directed to the primary node, which then replicates those changes to secondary nodes.",
        "hint": "Consider which node in a replica set is responsible for handling changes to the data."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What is an arbiter in a MongoDB replica set?",
        "options": ["A node that stores data and can become primary", "A node that only stores system metadata", "A node that doesn't store data but participates in elections", "A backup node that only activates when all others fail"],
        "correctOptionIndex": 2,
        "correctOptionText": "A node that doesn't store data but participates in elections",
        "difficulty": "easy",
        "explanation": "An arbiter is a MongoDB replica set member that does not store data but participates in primary elections to break ties in voting. Arbiters help maintain an odd number of voting members without requiring additional data storage.",
        "hint": "Think about a member that helps with voting but doesn't need to store any actual data."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What MongoDB shell command would you use to initiate a replica set?",
        "options": ["db.createReplicaSet()", "rs.initialize()", "rs.initiate()", "db.replicaSet.create()"],
        "correctOptionIndex": 2,
        "correctOptionText": "rs.initiate()",
        "difficulty": "easy",
        "explanation": "The rs.initiate() command is used to initiate a new replica set configuration. It turns a standalone MongoDB instance into a replica set or initializes a new replica set with the specified configuration.",
        "hint": "The 'rs' prefix refers to replica set commands in MongoDB."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "How does MongoDB maintain data consistency across a replica set?",
        "options": ["Through a distributed lock manager", "Using a two-phase commit protocol", "Via an operation log (oplog)", "Through synchronous writes to all nodes"],
        "correctOptionIndex": 2,
        "correctOptionText": "Via an operation log (oplog)",
        "difficulty": "medium",
        "explanation": "MongoDB maintains data consistency across a replica set by recording all data modifications in an operation log (oplog) on the primary node. Secondary nodes then copy and apply these operations to maintain consistency with the primary.",
        "hint": "MongoDB needs a way to track and transfer changes between replica set members."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What happens when the primary node in a replica set becomes unavailable?",
        "options": ["The replica set becomes read-only until manual intervention", "All operations fail until the primary comes back online", "The replica set automatically elects a new primary from the secondary nodes", "An arbiter takes over as the primary node"],
        "correctOptionIndex": 2,
        "correctOptionText": "The replica set automatically elects a new primary from the secondary nodes",
        "difficulty": "medium",
        "explanation": "When the primary node in a replica set becomes unavailable, the remaining secondary nodes automatically hold an election to select a new primary, ensuring continued availability of the database for both read and write operations.",
        "hint": "One of the main benefits of replication is automatic failover."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "Which of the following represents the correct syntax to check the status of a replica set?",
        "options": ["db.replicaSetStatus()", "rs.status()", "db.admin.replicaStatus()", "show replicaSet status"],
        "correctOptionIndex": 1,
        "correctOptionText": "rs.status()",
        "difficulty": "easy",
        "explanation": "The rs.status() command returns a document with information about the state of the replica set, including which member is primary, the state of each member, and replication lag information.",
        "hint": "This is a commonly used replica set (rs) shell command to get current status information."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What is the 'w' option in MongoDB write concern?",
        "options": ["The number of milliseconds to wait for write confirmation", "The total weight of the write operation", "The number of mongod instances that must acknowledge the write", "The write warning level"],
        "correctOptionIndex": 2,
        "correctOptionText": "The number of mongod instances that must acknowledge the write",
        "difficulty": "medium",
        "explanation": "The 'w' option in MongoDB's write concern specifies the number of mongod instances (primary and secondaries) that must acknowledge the write before considering it successful. It helps ensure data durability across the replica set.",
        "hint": "This option relates to how many servers must confirm a write operation."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "By default, can you read data from a secondary node in a MongoDB replica set?",
        "options": ["Yes, all reads are automatically distributed across all nodes", "Yes, but you must explicitly configure the read preference", "No, secondary nodes are only for failover purposes", "No, secondary nodes only process write operations"],
        "correctOptionIndex": 1,
        "correctOptionText": "Yes, but you must explicitly configure the read preference",
        "difficulty": "medium",
        "explanation": "By default, MongoDB directs all read operations to the primary member. To read from a secondary, you must explicitly set the read preference in your application or by running db.setReadPref() in the MongoDB shell.",
        "hint": "Secondary reads are possible but require an explicit setting change."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What is the maximum number of voting members allowed in a MongoDB replica set?",
        "options": ["5", "7", "50", "7 voting and 50 total"],
        "correctOptionIndex": 2,
        "correctOptionText": "7",
        "difficulty": "medium",
        "explanation": "MongoDB limits a replica set to a maximum of 7 voting members. This limit exists to prevent excessive overhead in the consensus protocol. A replica set can have up to 50 members total, but only 7 can have voting rights.",
        "hint": "There's a specific limit to maintain efficient consensus protocols."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What happens to the oplog when it reaches its maximum size?",
        "options": ["MongoDB automatically increases its size", "The oldest operations are removed in a FIFO manner", "Replication stops until the oplog is manually cleared", "MongoDB creates a new oplog collection"],
        "correctOptionIndex": 1,
        "correctOptionText": "The oldest operations are removed in a FIFO manner",
        "difficulty": "medium",
        "explanation": "The oplog is a capped collection, meaning when it reaches its maximum size, the oldest operations are removed first (First In, First Out). This behavior makes it important to size the oplog appropriately based on your application's write volume and replication requirements.",
        "hint": "Think about how capped collections generally behave in MongoDB."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "Which command would you use to add a new member to an existing replica set?",
        "options": ["rs.add()", "rs.addNode()", "rs.addMember()", "db.replicaSet.addNode()"],
        "correctOptionIndex": 0,
        "correctOptionText": "rs.add()",
        "difficulty": "easy",
        "explanation": "The rs.add() command is used to add a new member to an existing replica set. It can accept either a hostname:port string or a configuration document to specify the new member's properties.",
        "hint": "This simple command follows the rs.* pattern for replica set operations."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What priority value indicates that a replica set member can never become primary?",
        "options": ["-1", "0", "1", "null"],
        "correctOptionIndex": 1,
        "correctOptionText": "0",
        "difficulty": "medium",
        "explanation": "Setting a replica set member's priority to 0 prevents it from ever becoming the primary in an election. This is useful for members dedicated to specific purposes like backups or analytics, where being primary would be undesirable.",
        "hint": "A specific priority value makes a node ineligible for primary status."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What is the purpose of the 'j' option in MongoDB write concern?",
        "options": ["To specify the journal rotation frequency", "To require writes to be journaled before acknowledging", "To join multiple write operations into a single transaction", "To set the maximum journal size"],
        "correctOptionIndex": 1,
        "correctOptionText": "To require writes to be journaled before acknowledging",
        "difficulty": "medium",
        "explanation": "The 'j' option in MongoDB write concern, when set to true, requires that the write operation be written to the on-disk journal before acknowledging the write. This provides stronger durability guarantees as the operation will survive even if the server crashes immediately after the acknowledgment.",
        "hint": "This option relates to durability of write operations even in case of server crashes."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "In MongoDB, what is a hidden member in a replica set?",
        "options": ["A member not visible in rs.status() output", "A member that doesn't participate in voting", "A member that cannot be accessed by client applications", "A member with encrypted data that requires authentication"],
        "correctOptionIndex": 2,
        "correctOptionText": "A member that cannot be accessed by client applications",
        "difficulty": "medium",
        "explanation": "A hidden member in a MongoDB replica set is invisible to client applications (it cannot be read from even with secondary read preference) but still maintains a copy of the data and participates in voting. Hidden members are often used for dedicated tasks like backups or reporting.",
        "hint": "It's a special configuration that affects which nodes an application can connect to."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What is the purpose of heartbeats in a MongoDB replica set?",
        "options": ["To measure server performance", "To detect when members are unreachable", "To sync clocks between servers", "To compress data before replication"],
        "correctOptionIndex": 1,
        "correctOptionText": "To detect when members are unreachable",
        "difficulty": "medium",
        "explanation": "Heartbeats are regular pings sent between replica set members every 2 seconds. Their primary purpose is to check if other members are reachable and operating normally. This information is crucial for detecting when a member might be down and potentially triggering an election.",
        "hint": "Think about how members know if other members are still available."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "Which of the following is NOT a valid read preference mode in MongoDB?",
        "options": ["primary", "secondaryPreferred", "nearest", "fastestResponse"],
        "correctOptionIndex": 3,
        "correctOptionText": "fastestResponse",
        "difficulty": "medium",
        "explanation": "MongoDB supports five read preference modes: primary, primaryPreferred, secondary, secondaryPreferred, and nearest. 'fastestResponse' is not a valid read preference mode in MongoDB.",
        "hint": "Consider the standard read preference options that balance between consistency and availability."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "When a secondary member falls too far behind in replication, what status might it enter?",
        "options": ["STALE", "RECOVERING", "SECONDARY_DELAYED", "ERROR"],
        "correctOptionIndex": 1,
        "correctOptionText": "RECOVERING",
        "difficulty": "medium",
        "explanation": "When a secondary member falls too far behind in replication (e.g., if its oplog doesn't contain the operations it needs to replicate), it enters RECOVERING state. In this state, it's not available for reads and is attempting to sync from another member.",
        "hint": "The node enters a special state while trying to catch up with other members."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What is a delayed replica set member used for?",
        "options": ["Improving read performance", "Reducing network latency", "Disaster recovery from user errors", "Accelerating write operations"],
        "correctOptionIndex": 2,
        "correctOptionText": "Disaster recovery from user errors",
        "difficulty": "medium",
        "explanation": "A delayed replica set member intentionally lags behind the primary by a specified time period (e.g., 1 hour). This provides a rolling backup that can be used for disaster recovery from user errors, such as accidentally dropped collections or deleted documents.",
        "hint": "Think about why you might want a node that deliberately stays behind the current state."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "In MongoDB replication, what is the significance of the majority write concern?",
        "options": ["It requires all replica set members to acknowledge the write", "It requires acknowledgment from a majority of voting members", "It requires at least two members to acknowledge", "It only requires acknowledgment from the primary"],
        "correctOptionIndex": 1,
        "correctOptionText": "It requires acknowledgment from a majority of voting members",
        "difficulty": "hard",
        "explanation": "The 'majority' write concern requires that a write operation be acknowledged by a majority of the voting members in the replica set. This ensures that the write operation will persist even if a failover occurs, as it guarantees the data exists on enough servers to be elected primary.",
        "hint": "This write concern relates to ensuring writes survive failover events."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What configuration option would you use to make a secondary member in a replica set maintain a delay of 1 hour behind the primary?",
        "options": ["slaveDelay: 3600", "delay: 3600", "secondaryDelay: 3600", "replicationDelay: 3600"],
        "correctOptionIndex": 0,
        "correctOptionText": "slaveDelay: 3600",
        "difficulty": "hard",
        "explanation": "The 'slaveDelay' configuration option (measured in seconds) is used to specify how far behind the primary a secondary should lag. Setting 'slaveDelay: 3600' creates a secondary that is 1 hour (3600 seconds) behind the primary.",
        "hint": "The configuration uses seconds as the time unit."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What happens if a secondary member's oplog is not large enough to catch up after being offline?",
        "options": ["It automatically increases its oplog size", "It enters FATAL state and requires manual intervention", "It performs an initial sync, copying all data from scratch", "It downloads compressed oplog entries from the primary"],
        "correctOptionIndex": 2,
        "correctOptionText": "It performs an initial sync, copying all data from scratch",
        "difficulty": "hard",
        "explanation": "If a secondary's oplog doesn't contain the operations needed to catch up (because it was offline too long), it will perform an initial sync, which is a complete copy of all data from a current member of the replica set. This is resource-intensive and can impact performance.",
        "hint": "When incremental synchronization isn't possible, a more comprehensive approach is needed."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "Which factors influence primary election in a MongoDB replica set? (Select the most comprehensive answer)",
        "options": ["Only the priority setting of each member", "Priority setting and which member was primary most recently", "Priority, replication lag, and member health", "Priority, member health, oplog position, and network connectivity"],
        "correctOptionIndex": 3,
        "correctOptionText": "Priority, member health, oplog position, and network connectivity",
        "difficulty": "hard",
        "explanation": "MongoDB primary elections consider multiple factors: the priority setting of each member, health status, how up-to-date each member is (oplog position), and network connectivity between members. All these factors influence which secondary becomes the new primary during an election.",
        "hint": "Elections involve considering several different aspects of each potential candidate."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What is the term 'replication lag' referring to in MongoDB?",
        "options": ["The time delay in network communication between members", "The size difference between oplogs on different members", "The delay between a write on the primary and its application on a secondary", "The performance degradation caused by replication overhead"],
        "correctOptionIndex": 2,
        "correctOptionText": "The delay between a write on the primary and its application on a secondary",
        "difficulty": "medium",
        "explanation": "Replication lag refers to the time delay between when an operation is performed on the primary and when that same operation is applied on a secondary. High replication lag can lead to stale reads from secondaries and potential data loss during failover if not properly managed.",
        "hint": "It measures a time difference between the same operation on different members."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "Which command would you use to force a specific secondary member to become primary (assuming it's eligible)?",
        "options": ["rs.forcePrimary()", "rs.stepUp()", "rs.elect()", "rs.switchPrimary()"],
        "correctOptionIndex": 1,
        "correctOptionText": "rs.stepUp()",
        "difficulty": "hard",
        "explanation": "The rs.stepUp() command forces the current secondary to attempt to become primary. This command must be run directly on the secondary node you want to promote. It's useful for controlled failovers or maintenance scenarios.",
        "hint": "The name suggests the action of a secondary 'stepping up' to become primary."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "In a MongoDB replica set with a primary and multiple secondaries, what happens if you issue a write with {w: 'majority', j: true, wtimeout: 5000}?",
        "options": ["The write succeeds only if all members acknowledge it within 5 seconds", "The write succeeds if the primary and a majority of secondaries acknowledge it within 5 seconds", "The write succeeds if a majority of voting members have journaled the write within 5 seconds", "The write always succeeds on the primary but may timeout waiting for secondaries"],
        "correctOptionIndex": 2,
        "correctOptionText": "The write succeeds if a majority of voting members have journaled the write within 5 seconds",
        "difficulty": "hard",
        "explanation": "With {w: 'majority', j: true, wtimeout: 5000}, the write succeeds only if a majority of voting members have written the operation to their journal within 5000 milliseconds (5 seconds). If the timeout is reached before getting enough acknowledgments, the operation returns an error even though it may have been applied on some servers.",
        "hint": "Consider how the 'j' option modifies the basic majority write concern and what the timeout does."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What is the purpose of the local.oplog.rs collection in MongoDB?",
        "options": ["To store local database configuration", "To cache frequently accessed documents", "To record all modifications to the data for replication purposes", "To store authentication credentials for replica set members"],
        "correctOptionIndex": 2,
        "correctOptionText": "To record all modifications to the data for replication purposes",
        "difficulty": "medium",
        "explanation": "The local.oplog.rs collection is a special capped collection that stores an ordered history of all operations that modify the data stored in MongoDB. It serves as the replication mechanism by allowing secondary nodes to copy and apply operations from the primary in the same order.",
        "hint": "Think about what information needs to be shared between replica set members to maintain consistency."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "Which statement about replica set tags in MongoDB is FALSE?",
        "options": ["Tags can be used to customize write concern behavior", "Tags can be used to direct read operations to specific members", "Tags can influence which member becomes primary during an election", "Tags are stored as simple key-value pairs in the replica configuration"],
        "correctOptionIndex": 2,
        "correctOptionText": "Tags can influence which member becomes primary during an election",
        "difficulty": "hard",
        "explanation": "MongoDB replica set tags are used for customizing read preferences (to direct read operations to specific members) and write concerns (to ensure writes propagate to specific types of members). However, tags do NOT influence which member becomes primary during an election - that's determined by priority settings, not tags.",
        "hint": "Consider what configuration parameters actually influence election outcomes."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Replication",
        "questionText": "What is the main limitation when using a MongoDB replica set with only two voting members?",
        "options": ["Secondaries cannot perform reads", "Write performance is significantly reduced", "Automatic failover is not possible", "Data consistency cannot be guaranteed"],
        "correctOptionIndex": 2,
        "correctOptionText": "Automatic failover is not possible",
        "difficulty": "hard",
        "explanation": "A MongoDB replica set with only two voting members cannot automatically elect a new primary if the current primary fails because elections require a majority vote. With two voting members, you need both to achieve a majority, but if one is down, you have only 1 of 2 members, which is not a majority. Adding an arbiter as a third voting member solves this problem.",
        "hint": "Think about the mathematics of majority in a two-node system when one node fails."
    },
    ...
    // Sharding
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What is the primary purpose of sharding in MongoDB?",
        "options": ["To increase data security", "To improve read/write performance through horizontal scaling", "To provide high availability", "To enable schema validation"],
        "correctOptionIndex": 1,
        "correctOptionText": "To improve read/write performance through horizontal scaling",
        "difficulty": "easy",
        "explanation": "Sharding in MongoDB is a method for distributing data across multiple machines (horizontal scaling) to support deployments with very large data sets and high throughput operations. This horizontal scaling allows MongoDB to handle more requests and store more data than a single server would be able to handle.",
        "hint": "Think about how sharding helps MongoDB deal with very large datasets."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "Which of the following is NOT a required component in a MongoDB sharded cluster?",
        "options": ["Config servers", "Mongos router", "Shards", "Arbiter"],
        "correctOptionIndex": 3,
        "correctOptionText": "Arbiter",
        "difficulty": "easy",
        "explanation": "A MongoDB sharded cluster consists of three main components: shards (which contain the data), config servers (which store metadata and configuration settings), and mongos routers (which route requests to the appropriate shards). Arbiters are optional components in replica sets but are not required components in a sharded cluster.",
        "hint": "Consider which components are essential for a sharded architecture versus which are related to replication."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What is a shard key in MongoDB?",
        "options": ["A secret key used to authenticate shards", "The unique identifier of each shard", "The field(s) used to distribute documents among shards", "A backup key for shard recovery"],
        "correctOptionIndex": 2,
        "correctOptionText": "The field(s) used to distribute documents among shards",
        "difficulty": "easy",
        "explanation": "A shard key in MongoDB is a field or multiple fields from a collection's documents that MongoDB uses to distribute the documents among the shards in a cluster. The choice of shard key significantly impacts the performance, efficiency, and scalability of the sharded cluster.",
        "hint": "How does MongoDB know which shard to store a particular document in?"
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "Which command is used to enable sharding for a database in MongoDB?",
        "options": ["db.enableSharding()", "sh.enableSharding()", "db.shardCollection()", "mongo --shardsvr"],
        "correctOptionIndex": 1,
        "correctOptionText": "sh.enableSharding()",
        "difficulty": "easy",
        "explanation": "The sh.enableSharding() command is used to enable sharding for a specific database in MongoDB. This is the first step before you can shard any collections within that database. For example: sh.enableSharding(\"mydb\").",
        "hint": "The command uses the 'sh' namespace, which relates to sharding operations."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What is a chunk in MongoDB sharding?",
        "options": ["A backup segment of the database", "A contiguous range of shard key values within a sharded collection", "A group of MongoDB servers working together", "A specialized data format for efficient storage"],
        "correctOptionIndex": 1,
        "correctOptionText": "A contiguous range of shard key values within a sharded collection",
        "difficulty": "medium",
        "explanation": "In MongoDB sharding, a chunk is a contiguous range of shard key values within a sharded collection. MongoDB distributes chunks among the shards in a cluster to evenly distribute the data. Each chunk has an inclusive lower bound and an exclusive upper bound for the shard key values.",
        "hint": "Chunks are related to how data is divided across shards based on key ranges."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What is the minimum recommended number of config servers in a production MongoDB sharded cluster?",
        "options": ["1", "2", "3", "5"],
        "correctOptionIndex": 2,
        "correctOptionText": "3",
        "difficulty": "medium",
        "explanation": "In a production MongoDB sharded cluster, the minimum recommended number of config servers is 3. Config servers store the metadata for the sharded cluster, and having at least 3 ensures high availability and fault tolerance. Since MongoDB 3.4, config servers must be deployed as a replica set.",
        "hint": "Think about what number would provide redundancy while allowing for majority consensus."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "Which of the following shard key characteristics is MOST important for efficient sharding?",
        "options": ["The key should be frequently updated", "The key should have high cardinality", "The key should always be a compound key", "The key should be a 32-bit integer"],
        "correctOptionIndex": 1,
        "correctOptionText": "The key should have high cardinality",
        "difficulty": "medium",
        "explanation": "High cardinality in a shard key means that the key has a large number of unique values. This is important for efficient sharding because it allows MongoDB to distribute data more evenly across shards. Keys with low cardinality can lead to uneven distribution and the creation of jumbo chunks that cannot be moved easily.",
        "hint": "Consider what property would help distribute documents most evenly among shards."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What command would you use to shard a collection in MongoDB?",
        "options": ["db.collection.shard()", "sh.shardCollection()", "db.enableShardingOnCollection()", "sh.createShardedCollection()"],
        "correctOptionIndex": 1,
        "correctOptionText": "sh.shardCollection()",
        "difficulty": "easy",
        "explanation": "The sh.shardCollection() command is used to enable sharding for a specific collection in MongoDB. This command requires the full namespace of the collection (database.collection) and the shard key. For example: sh.shardCollection(\"mydb.users\", {user_id: 1}).",
        "hint": "This command follows the pattern of other sharding commands in the 'sh' namespace."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What happens when a query in a sharded cluster does NOT include the shard key?",
        "options": ["The query fails with an error", "The query is automatically optimized to include the shard key", "The query is sent to a single shard only", "The query is broadcast to all shards"],
        "correctOptionIndex": 3,
        "correctOptionText": "The query is broadcast to all shards",
        "difficulty": "medium",
        "explanation": "When a query does not include the shard key, the mongos router must broadcast the query to all shards in the cluster. This is known as a 'scatter-gather' operation and is less efficient than targeted queries that include the shard key, which can be routed directly to the relevant shard(s).",
        "hint": "Consider how MongoDB would need to handle a query when it doesn't know which shard contains the requested data."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "Which process is responsible for balancing chunks across shards in MongoDB?",
        "options": ["The config server", "The primary shard", "The balancer", "The mongos router"],
        "correctOptionIndex": 2,
        "correctOptionText": "The balancer",
        "difficulty": "medium",
        "explanation": "MongoDB's balancer is a background process that monitors the chunk distribution across the shards and automatically migrates chunks between shards to ensure an even distribution. The balancer runs on the primary config server and moves chunks from shards with more chunks to shards with fewer chunks.",
        "hint": "A specific process is dedicated to maintaining even data distribution in a sharded cluster."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What is a primary shard in MongoDB?",
        "options": ["The first shard created in a cluster", "The shard that contains the most data", "The shard designated to hold all non-sharded collections for a database", "The shard that runs the balancer process"],
        "correctOptionIndex": 2,
        "correctOptionText": "The shard designated to hold all non-sharded collections for a database",
        "difficulty": "medium",
        "explanation": "In MongoDB, each database has a primary shard that holds all the non-sharded collections for that database. When you create a new database, MongoDB assigns a primary shard for the database based on the data distribution across the cluster at that time.",
        "hint": "Even in a sharded environment, not all collections might be sharded; these need to be stored somewhere specific."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "Which of the following is a valid sharding strategy in MongoDB?",
        "options": ["Random sharding", "Round-robin sharding", "Ranged sharding", "Sequential sharding"],
        "correctOptionIndex": 2,
        "correctOptionText": "Ranged sharding",
        "difficulty": "medium",
        "explanation": "Ranged sharding is a valid sharding strategy in MongoDB where documents are divided based on ranges of shard key values. Each chunk is assigned a range of shard key values. MongoDB also supports hashed sharding, where the shard key values are hashed to determine chunk assignment, but not random or round-robin sharding.",
        "hint": "MongoDB distributes data using specific strategies based on either the actual values or a transformation of them."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What is the main disadvantage of ranged sharding compared to hashed sharding?",
        "options": ["Ranged sharding uses more storage space", "Ranged sharding cannot support compound shard keys", "Ranged sharding may lead to uneven data distribution if the shard key has poor distribution", "Ranged sharding is significantly slower for write operations"],
        "correctOptionIndex": 2,
        "correctOptionText": "Ranged sharding may lead to uneven data distribution if the shard key has poor distribution",
        "difficulty": "medium",
        "explanation": "The main disadvantage of ranged sharding is that it can lead to uneven data distribution if the shard key values do not distribute evenly or if the data has a monotonically increasing or decreasing pattern (like timestamps or sequential IDs). This can result in 'hot spots' where some shards receive a disproportionate amount of writes.",
        "hint": "Consider how data might be distributed if the key values follow a pattern like timestamp or sequential identifiers."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What is a jumbo chunk in MongoDB sharding?",
        "options": ["A chunk that contains binary data", "A chunk that exceeds the maximum size and cannot be split", "A chunk that spans multiple shards", "A chunk with high priority for balancing"],
        "correctOptionIndex": 1,
        "correctOptionText": "A chunk that exceeds the maximum size and cannot be split",
        "difficulty": "hard",
        "explanation": "A jumbo chunk in MongoDB is a chunk that exceeds the maximum size limit (default 64MB) but cannot be split further because the shard key values within it are identical or the chunk represents the smallest range of shard key values. Jumbo chunks can cause problems for the balancer and data distribution.",
        "hint": "These problematic chunks arise from limitations in how chunks can be divided further."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "Once a collection is sharded in MongoDB, can the shard key be changed?",
        "options": ["Yes, at any time using sh.reshardCollection()", "Yes, but only if the collection is empty", "No, the shard key is immutable once set", "Yes, but only by creating a new sharded collection and migrating data"],
        "correctOptionIndex": 2,
        "correctOptionText": "No, the shard key is immutable once set",
        "difficulty": "medium",
        "explanation": "In MongoDB versions prior to 4.4, the shard key is immutable once set. After sharding a collection, you cannot change the shard key fields or update the values of a document's shard key fields (though as of MongoDB 4.2, you can update some shard key values in certain configurations). Starting in MongoDB 4.4, it's possible to refine a shard key using the reshardCollection command.",
        "hint": "Consider the complexity of redistributing all data if this fundamental property were to change."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What is the purpose of the config database in a MongoDB sharded cluster?",
        "options": ["To store user authentication information", "To store metadata about the sharded data distribution", "To configure replication settings", "To store performance metrics"],
        "correctOptionIndex": 1,
        "correctOptionText": "To store metadata about the sharded data distribution",
        "difficulty": "medium",
        "explanation": "The config database in a MongoDB sharded cluster stores metadata about the cluster, including information about shards, chunks, their distribution, and the mapping of chunks to shards. This metadata is stored on the config servers and is crucial for the mongos routers to correctly route operations to the appropriate shards.",
        "hint": "This special database contains information that helps coordinate the entire sharded environment."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "Which of the following operations CANNOT be performed in a sharded MongoDB environment?",
        "options": ["Map-reduce operations", "Text search", "Renaming a sharded collection", "Aggregation pipeline"],
        "correctOptionIndex": 2,
        "correctOptionText": "Renaming a sharded collection",
        "difficulty": "hard",
        "explanation": "Renaming a sharded collection is not supported in MongoDB. This operation is not allowed because it would require complex coordination across all shards and would create significant risks for data consistency. To effectively rename a sharded collection, you would need to create a new collection with the desired name and migrate all data.",
        "hint": "Some operations that are simple in a non-sharded environment become very complex or impossible in a sharded environment."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What command would you use to check the status of the balancer in a MongoDB sharded cluster?",
        "options": ["db.printBalancerStatus()", "sh.getBalancerState()", "sh.status()", "db.adminCommand({balancerStatus: 1})"],
        "correctOptionIndex": 1,
        "correctOptionText": "sh.getBalancerState()",
        "difficulty": "medium",
        "explanation": "The sh.getBalancerState() command is used to check whether the balancer is currently enabled or disabled in a MongoDB sharded cluster. It returns true if the balancer is enabled and false if it's disabled. This command does not indicate whether the balancer is actively running migrations.",
        "hint": "Look for a command in the 'sh' namespace that inquires about the balancer's current configuration."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What is a zone in MongoDB sharding?",
        "options": ["A geographic region where shards are deployed", "A logical grouping of shards associated with specific shard key ranges", "A security boundary for access control", "A dedicated area in memory for frequently accessed data"],
        "correctOptionIndex": 1,
        "correctOptionText": "A logical grouping of shards associated with specific shard key ranges",
        "difficulty": "hard",
        "explanation": "In MongoDB sharding, a zone is a logical grouping of shards that is associated with one or more ranges of shard key values. Zones allow you to control which shards receive documents based on the shard key. This feature is useful for data locality, tiered storage, or isolating workloads to specific hardware.",
        "hint": "This feature helps you control where specific data is stored within your sharded cluster."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What happens when a mongos router in a sharded cluster becomes unavailable?",
        "options": ["All operations on the cluster fail until it's restored", "The balancer automatically launches a new mongos instance", "Existing connections to that mongos fail, but the cluster continues to operate through other mongos instances", "The primary shard takes over the routing functionality"],
        "correctOptionIndex": 2,
        "correctOptionText": "Existing connections to that mongos fail, but the cluster continues to operate through other mongos instances",
        "difficulty": "medium",
        "explanation": "In a typical sharded MongoDB cluster, multiple mongos routers are deployed for redundancy. If one mongos router becomes unavailable, client applications connected to that specific router will experience failures, but the overall cluster continues to operate through other mongos instances. Clients can reconnect to other mongos routers to resume operations.",
        "hint": "Consider the recommended deployment architecture for production environments and how it handles component failures."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "Which type of index must exist on the shard key fields before sharding a collection?",
        "options": ["Text index", "Hashed index", "Any index that includes the shard key fields", "The index type doesn't matter"],
        "correctOptionIndex": 2,
        "correctOptionText": "Any index that includes the shard key fields",
        "difficulty": "medium",
        "explanation": "Before sharding a collection, the shard key fields must be indexed, either as a single-field index, a compound index (where the shard key fields are a prefix of the index), or a hashed index (for hashed sharding). Without this index, MongoDB will not allow the collection to be sharded.",
        "hint": "MongoDB requires a specific prerequisite before a collection can be sharded."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What is the default chunk size in MongoDB sharded clusters?",
        "options": ["16 MB", "32 MB", "64 MB", "128 MB"],
        "correctOptionIndex": 2,
        "correctOptionText": "64 MB",
        "difficulty": "medium",
        "explanation": "The default chunk size in MongoDB sharded clusters is 64 MB. This size represents the maximum amount of data that should be stored in a chunk before MongoDB attempts to split it. The chunk size is configurable and can be adjusted based on specific requirements, though changing it can impact the performance of migrations and the balancer.",
        "hint": "This value determines when chunks are split as they grow in size."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What are the main advantages of hashed sharding compared to ranged sharding?",
        "options": ["Faster query performance and smaller storage requirements", "Better support for compound shard keys and more efficient indexing", "More even data distribution and better prevention of hotspots", "Lower network overhead and better support for zone mapping"],
        "correctOptionIndex": 2,
        "correctOptionText": "More even data distribution and better prevention of hotspots",
        "difficulty": "hard",
        "explanation": "Hashed sharding distributes data more evenly across shards by hashing the shard key values, which helps prevent 'hotspots' that can occur with ranged sharding, especially when the shard key has a monotonically increasing pattern (like timestamps). This results in a more balanced write distribution, though it sacrifices the ability to perform range-based queries efficiently.",
        "hint": "Consider how transforming values through a hash function affects their distribution pattern."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What process is responsible for splitting chunks when they grow beyond the maximum chunk size?",
        "options": ["The balancer", "The mongos router", "The primary in each shard", "The primary config server"],
        "correctOptionIndex": 0,
        "correctOptionText": "The balancer",
        "difficulty": "hard",
        "explanation": "In MongoDB, the balancer process is responsible for both splitting chunks when they grow beyond the maximum chunk size and for migrating chunks between shards to ensure an even distribution. When a write operation would cause a chunk to exceed the maximum size, the balancer automatically splits the chunk based on the shard key ranges.",
        "hint": "The same process that handles redistributing chunks also manages their size."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "Which of the following fields would make a poor shard key choice for a collection with global user data where queries often filter by country?",
        "options": ["user_id (high cardinality)", "country_code (medium cardinality)", "account_type (low cardinality, only 3 values)", "email_domain (medium-high cardinality)"],
        "correctOptionIndex": 2,
        "correctOptionText": "account_type (low cardinality, only 3 values)",
        "difficulty": "hard",
        "explanation": "A field with very low cardinality, such as account_type with only 3 values, makes a poor shard key because it would result in very few chunks that cannot be split effectively. This leads to uneven data distribution and creates 'jumbo chunks' that cannot be moved by the balancer. For globally distributed user data queried by country, a compound key including country_code would be better.",
        "hint": "Consider how many distinct values exist in each proposed field and how that affects chunk creation and data distribution."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What command would you use to add a new shard to an existing sharded cluster?",
        "options": ["db.addShard()", "sh.addShard()", "mongos --addshard", "config.shards.insert()"],
        "correctOptionIndex": 1,
        "correctOptionText": "sh.addShard()",
        "difficulty": "medium",
        "explanation": "The sh.addShard() command is used to add a new shard to an existing MongoDB sharded cluster. This command takes a connection string to the new shard server or replica set. For example: sh.addShard(\"rs1/mongod1.example.net:27017,mongod2.example.net:27017\").",
        "hint": "Look for a command in the 'sh' namespace that would add a component to the cluster."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "Which statement about sharded indexes is TRUE?",
        "options": ["Each shard maintains completely independent indexes", "Indexes are only stored on the config servers", "All shards must have identical index definitions for sharded collections", "Only the primary shard needs indexes for a collection"],
        "correctOptionIndex": 2,
        "correctOptionText": "All shards must have identical index definitions for sharded collections",
        "difficulty": "hard",
        "explanation": "In a MongoDB sharded cluster, all shards must maintain identical index definitions for sharded collections. When you create or drop an index on a sharded collection, MongoDB propagates that operation to all shards that contain chunks for that collection. This ensures consistent query execution across all shards.",
        "hint": "Consider what would happen if different shards had different indexes when executing the same query across multiple shards."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "Which of these operations would cause the most performance issues in a sharded environment if performed frequently?",
        "options": ["Point queries including the exact shard key", "Queries filtered by a non-shard key field with an index", "Updates to the shard key values", "Aggregation operations with $match on shard key"],
        "correctOptionIndex": 2,
        "correctOptionText": "Updates to the shard key values",
        "difficulty": "hard",
        "explanation": "Updates to shard key values in a sharded collection can cause significant performance issues because they might require documents to be moved between shards. Prior to MongoDB 4.2, updates to shard key values were not allowed at all. Even in newer versions, these updates can be expensive operations because they may involve deleting the document from one shard and inserting it into another.",
        "hint": "Think about what happens when a document's shard key changes, potentially requiring relocation within the cluster."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "What is a tag-aware sharding in MongoDB?",
        "options": ["A method to label shards with specific hardware capabilities", "A feature that optimizes shard keys based on access patterns", "A technique to associate shard key ranges with specific shards for targeted data placement", "A process that tags documents with metadata about their shard location"],
        "correctOptionIndex": 2,
        "correctOptionText": "A technique to associate shard key ranges with specific shards for targeted data placement",
        "difficulty": "hard",
        "explanation": "Tag-aware sharding (now called zone sharding) in MongoDB is a technique that allows you to associate specific ranges of shard key values with specific shards. This gives you control over which data is stored on which shards, enabling use cases like data locality (storing data close to users in specific regions) or tiered storage (storing different classes of data on different types of hardware).",
        "hint": "This feature gives administrators more control over where specific data is physically located."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "Which of the following operations must be sent to all shards in a sharded cluster regardless of the shard key used in the query?",
        "options": ["find() with a sort on non-shard key fields", "$text search operations", "$group aggregation operations", "All of the above"],
        "correctOptionIndex": 3,
        "correctOptionText": "All of the above",
        "difficulty": "hard",
        "explanation": "All of these operations must be sent to all shards in a sharded cluster because they need to consider all documents or require merging results from all shards: sorting on non-shard key fields (because documents on different shards might need to be included in the sorted results), $text search operations (because they search across all documents), and $group aggregation operations (because they need to group data that might be spread across multiple shards).",
        "hint": "Consider which operations inherently need data from across the entire collection regardless of how it's sharded."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Sharding",
        "questionText": "When removing a shard from a MongoDB sharded cluster using sh.removeShard(), what happens to the data on that shard?",
        "options": ["It is immediately deleted", "It remains on the server but becomes inaccessible", "It is automatically migrated to other shards before the shard is removed", "It is backed up to the config servers"],
        "correctOptionIndex": 2,
        "correctOptionText": "It is automatically migrated to other shards before the shard is removed",
        "difficulty": "hard",
        "explanation": "When removing a shard using sh.removeShard(), MongoDB automatically migrates all chunks from the target shard to other shards in the cluster before completing the removal process. This ensures no data is lost. The process occurs in phases and can be monitored using the sh.removeShardStatus() command.",
        "hint": "MongoDB has a built-in process to ensure data integrity when scaling down a cluster."
    },
    ...
    // Security Authentication
    {
        ...
        "questionText": "What authentication mechanism uses X.509 certificates to authenticate clients?",
        "options": ["SCRAM-SHA-256", "MONGODB-CR", "X.509", "LDAP"],
        "correctOptionIndex": 2,
        "correctOptionText": "X.509",
        "difficulty": "medium",
        "explanation": "X.509 is an authentication mechanism that uses X.509 certificates to authenticate clients to MongoDB servers, and MongoDB servers to clients.",
        "hint": "This authentication method involves PKI (Public Key Infrastructure)."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "Which command is used to create a new user in MongoDB?",
        "options": ["db.createUser()", "db.addUser()", "db.newUser()", "db.insertUser()"],
        "correctOptionIndex": 0,
        "correctOptionText": "db.createUser()",
        "difficulty": "easy",
        "explanation": "The db.createUser() method adds a user to the current database and specifies the user's credentials and roles.",
        "hint": "This method follows the standard CRUD naming convention in MongoDB."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What is the default authentication database in MongoDB?",
        "options": ["users", "auth", "admin", "system"],
        "correctOptionIndex": 2,
        "correctOptionText": "admin",
        "difficulty": "easy",
        "explanation": "By default, MongoDB stores user credentials in the admin database, which is the default authentication database.",
        "hint": "This database is often used for administrative operations."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "Which of the following is NOT a built-in user role in MongoDB?",
        "options": ["readWrite", "dbAdmin", "userAdmin", "superUser"],
        "correctOptionIndex": 3,
        "correctOptionText": "superUser",
        "difficulty": "medium",
        "explanation": "MongoDB has several built-in roles like readWrite, dbAdmin, and userAdmin, but 'superUser' is not one of them. The closest equivalent would be the 'root' role.",
        "hint": "Think about which role doesn't follow MongoDB's role naming conventions."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What command-line option enables authentication in MongoDB?",
        "options": ["--auth", "--authenticate", "--security", "--enable-auth"],
        "correctOptionIndex": 0,
        "correctOptionText": "--auth",
        "difficulty": "easy",
        "explanation": "The --auth option enables authentication, requiring clients to authenticate themselves before performing operations.",
        "hint": "It's a simple flag that can be used when starting the MongoDB server."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What built-in role provides read-only access to all non-system collections in all databases?",
        "options": ["readAnyDatabase", "read", "viewUser", "readAll"],
        "correctOptionIndex": 0,
        "correctOptionText": "readAnyDatabase",
        "difficulty": "medium",
        "explanation": "The readAnyDatabase role provides read-only access to all non-system collections across all databases in a MongoDB deployment.",
        "hint": "This role extends read permissions beyond a single database."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What is the default authentication mechanism in MongoDB 4.0 and later?",
        "options": ["MONGODB-CR", "SCRAM-SHA-1", "SCRAM-SHA-256", "PLAIN"],
        "correctOptionIndex": 2,
        "correctOptionText": "SCRAM-SHA-256",
        "difficulty": "medium",
        "explanation": "Starting with MongoDB 4.0, SCRAM-SHA-256 is the default authentication mechanism, providing stronger security than the previous SCRAM-SHA-1.",
        "hint": "This uses a more secure hashing algorithm than earlier versions."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "Which role is required to view the system.users collection?",
        "options": ["userAdmin", "dbAdmin", "readAnyDatabase", "clusterAdmin"],
        "correctOptionIndex": 0,
        "correctOptionText": "userAdmin",
        "difficulty": "medium",
        "explanation": "The userAdmin role provides access to view and modify user information, including the system.users collection.",
        "hint": "This role is specifically designed for managing users and their privileges."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What parameter would you use in the connection string to specify the authentication database?",
        "options": ["authSource", "authDB", "authenticationDB", "authDatabase"],
        "correctOptionIndex": 0,
        "correctOptionText": "authSource",
        "difficulty": "medium",
        "explanation": "The authSource parameter in the connection string specifies the database that MongoDB should use for authentication credentials.",
        "hint": "This parameter indicates where the user credentials are stored."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "Which of the following is NOT a valid authentication mechanism in MongoDB?",
        "options": ["SCRAM-SHA-256", "MONGODB-X509", "Kerberos", "OAuth2"],
        "correctOptionIndex": 3,
        "correctOptionText": "OAuth2",
        "difficulty": "medium",
        "explanation": "MongoDB supports various authentication mechanisms including SCRAM-SHA-256, MONGODB-X509, and Kerberos, but OAuth2 is not directly supported as a built-in authentication mechanism.",
        "hint": "Think about which mechanism is commonly used for web applications but not natively in MongoDB."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What command is used to change a user's password in MongoDB?",
        "options": ["db.updateUser()", "db.changePassword()", "db.setPassword()", "db.resetPassword()"],
        "correctOptionIndex": 0,
        "correctOptionText": "db.updateUser()",
        "difficulty": "easy",
        "explanation": "The db.updateUser() command is used to update user information, including changing the password for an existing user.",
        "hint": "This follows the standard update pattern in MongoDB commands."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "Which configuration file parameter enables TLS/SSL for MongoDB connections?",
        "options": ["security.ssl", "net.ssl", "net.tls", "security.tls"],
        "correctOptionIndex": 1,
        "correctOptionText": "net.ssl",
        "difficulty": "medium",
        "explanation": "In the MongoDB configuration file, the net.ssl parameter (or net.tls in newer versions) enables TLS/SSL for all MongoDB connections.",
        "hint": "This setting is under the networking section of the configuration file."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What is the purpose of role-based access control (RBAC) in MongoDB?",
        "options": ["To encrypt data at rest", "To restrict access to specific collections", "To assign privileges to users through roles", "To monitor database access patterns"],
        "correctOptionIndex": 2,
        "correctOptionText": "To assign privileges to users through roles",
        "difficulty": "easy",
        "explanation": "RBAC in MongoDB allows administrators to assign privileges to users through roles, making it easier to manage permissions across multiple users.",
        "hint": "This security approach focuses on grouping permissions rather than assigning them individually."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "Which of the following is required to enable client certificate validation in MongoDB?",
        "options": ["CAFile", "PEMKeyFile", "certificateValidation", "clientCertificate"],
        "correctOptionIndex": 0,
        "correctOptionText": "CAFile",
        "difficulty": "hard",
        "explanation": "The CAFile parameter specifies the certificate authority file that MongoDB uses to validate client certificates for client certificate authentication.",
        "hint": "This file contains the trusted certificate authorities that issued the client certificates."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What happens if you try to create a user with a role that doesn't exist?",
        "options": ["The user is created without any roles", "MongoDB creates the role automatically", "MongoDB throws an error", "The user is created with the default role"],
        "correctOptionIndex": 2,
        "correctOptionText": "MongoDB throws an error",
        "difficulty": "medium",
        "explanation": "If you try to create a user with a non-existent role, MongoDB will throw an error indicating that the role doesn't exist. Roles must be defined before they can be assigned to users.",
        "hint": "MongoDB requires all referenced entities to exist when creating relationships."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "Which command shows all users in the current database?",
        "options": ["db.getUsers()", "db.showUsers()", "db.users.find()", "db.system.users.find()"],
        "correctOptionIndex": 0,
        "correctOptionText": "db.getUsers()",
        "difficulty": "easy",
        "explanation": "The db.getUsers() command returns information about all users in the current database.",
        "hint": "This is a specific user management command, not a regular collection query."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What privilege is required to run the db.createRole() command?",
        "options": ["createUser", "createRole", "userAdmin", "dbAdmin"],
        "correctOptionIndex": 2,
        "correctOptionText": "userAdmin",
        "difficulty": "medium",
        "explanation": "The userAdmin role provides the necessary privileges to create and modify roles using commands like db.createRole().",
        "hint": "This role manages both user and role aspects of authentication."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "Which encryption feature in MongoDB Enterprise encrypts data before it is written to disk?",
        "options": ["TLS/SSL encryption", "Field Level Encryption", "Encrypted Storage Engine", "Wire Protocol Encryption"],
        "correctOptionIndex": 2,
        "correctOptionText": "Encrypted Storage Engine",
        "difficulty": "hard",
        "explanation": "The Encrypted Storage Engine (WiredTiger with encryption) in MongoDB Enterprise encrypts data before it is written to disk, providing encryption at rest.",
        "hint": "This feature operates at the storage layer rather than the application layer."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What is Field Level Encryption in MongoDB?",
        "options": ["Encrypting the entire database", "Encrypting specific fields in documents", "Encrypting network communication", "Encrypting database credentials"],
        "correctOptionIndex": 1,
        "correctOptionText": "Encrypting specific fields in documents",
        "difficulty": "hard",
        "explanation": "Field Level Encryption allows encrypting specific fields in documents on the client side before sending them to the server, ensuring sensitive data remains encrypted even when in use.",
        "hint": "This provides more granular control over what data is encrypted within documents."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "Which command revokes roles from a user?",
        "options": ["db.revokeRolesFromUser()", "db.removeRoles()", "db.dropUserRoles()", "db.updateUser()"],
        "correctOptionIndex": 0,
        "correctOptionText": "db.revokeRolesFromUser()",
        "difficulty": "medium",
        "explanation": "The db.revokeRolesFromUser() command removes the specified roles from a user on the current database.",
        "hint": "The command name explicitly describes its purpose of revoking roles."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "In MongoDB, what is the minimum role required to read data from any collection in a specific database?",
        "options": ["read", "readWrite", "dbReader", "dbAdmin"],
        "correctOptionIndex": 0,
        "correctOptionText": "read",
        "difficulty": "easy",
        "explanation": "The read role provides the ability to read data from any collection in the database to which the role is assigned.",
        "hint": "This is the most basic read access role in MongoDB's role system."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "Which authentication mechanism would be most appropriate for integrating MongoDB with a corporate Active Directory infrastructure?",
        "options": ["SCRAM-SHA-256", "Kerberos", "LDAP", "X.509"],
        "correctOptionIndex": 2,
        "correctOptionText": "LDAP",
        "difficulty": "hard",
        "explanation": "LDAP authentication allows MongoDB Enterprise to authenticate users directly against a corporate LDAP server such as Microsoft Active Directory.",
        "hint": "This mechanism is specifically designed for directory service integration."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "When using MongoDB's Encrypted Storage Engine, where are the encryption keys stored?",
        "options": ["In the MongoDB database", "In a separate key management system", "In the MongoDB configuration file", "In environment variables"],
        "correctOptionIndex": 1,
        "correctOptionText": "In a separate key management system",
        "difficulty": "hard",
        "explanation": "The Encrypted Storage Engine uses external key management systems (KMS) to store master encryption keys, separating key management from the database for improved security.",
        "hint": "This approach follows security best practices by separating encryption keys from the data they protect."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What is the primary purpose of MongoDB's auditing feature?",
        "options": ["To encrypt sensitive data", "To track database operations and access", "To validate user credentials", "To prevent unauthorized access"],
        "correctOptionIndex": 1,
        "correctOptionText": "To track database operations and access",
        "difficulty": "medium",
        "explanation": "MongoDB's auditing feature records database operations and access patterns, providing a record of activities that can be used for security analysis and compliance purposes.",
        "hint": "This feature is about monitoring and recording activity rather than preventing it."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "Which file format is used for storing MongoDB server certificates?",
        "options": ["JKS", "PEM", "P12", "DER"],
        "correctOptionIndex": 1,
        "correctOptionText": "PEM",
        "difficulty": "medium",
        "explanation": "MongoDB uses PEM (Privacy Enhanced Mail) format for TLS/SSL certificates and keys. The server certificate and private key are typically stored in a single PEM file.",
        "hint": "This is a common format for storing cryptographic keys and certificates in text form."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What does the authenticationRestrictions parameter do when creating a user?",
        "options": ["Limits authentication attempts", "Restricts which databases the user can access", "Limits which client IP addresses can authenticate", "Sets password complexity requirements"],
        "correctOptionIndex": 2,
        "correctOptionText": "Limits which client IP addresses can authenticate",
        "difficulty": "hard",
        "explanation": "The authenticationRestrictions parameter allows you to specify client IP addresses or CIDR ranges from which users are allowed to authenticate, adding an additional layer of security.",
        "hint": "This feature provides network-level restrictions on authentication."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What command would you use to add additional roles to an existing user?",
        "options": ["db.addRolesToUser()", "db.grantRoles()", "db.updateUserRoles()", "db.modifyUserRoles()"],
        "correctOptionIndex": 0,
        "correctOptionText": "db.addRolesToUser()",
        "difficulty": "medium",
        "explanation": "The db.addRolesToUser() command adds the specified roles to a user on the current database without affecting existing roles.",
        "hint": "The command name clearly describes its purpose of adding roles to a user."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "Which of the following is NOT a valid action in MongoDB's role-based access control system?",
        "options": ["find", "insert", "remove", "select"],
        "correctOptionIndex": 3,
        "correctOptionText": "select",
        "difficulty": "medium",
        "explanation": "MongoDB uses actions like find, insert, update, and remove to define privileges, but 'select' is not a valid MongoDB action (it's more commonly associated with SQL databases).",
        "hint": "Consider which term comes from a different database paradigm."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "What system variable would you check to see if authentication is enabled on a MongoDB server?",
        "options": ["db.adminCommand({getParameter: 1, 'security.authentication': 1})", "db.runCommand({isAuthEnabled: 1})", "db.serverStatus().security", "db.getAuthStatus()"],
        "correctOptionIndex": 0,
        "correctOptionText": "db.adminCommand({getParameter: 1, 'security.authentication': 1})",
        "difficulty": "hard",
        "explanation": "You can check if authentication is enabled by running the getParameter command with the security.authentication parameter from the admin database.",
        "hint": "This uses the admin command interface to retrieve server configuration parameters."
    },
    {
        "topic": "67defc28e107cf2e3745af6a",
        "module": "Security & Authentication",
        "questionText": "When is a MongoDB user automatically logged out after authentication?",
        "options": ["After 30 minutes of inactivity", "When the server restarts", "When the connection is closed", "MongoDB users never automatically log out"],
        "correctOptionIndex": 2,
        "correctOptionText": "When the connection is closed",
        "difficulty": "easy",
        "explanation": "In MongoDB, authentication is tied to a connection. When a connection is closed, the user is effectively logged out and must authenticate again on a new connection.",
        "hint": "Think about the scope of authentication in database connections."
    },
