const nodeJSQuestions = [
    ...
    // Advanced Topics
    {
        ...
        "questionText": "What is the primary purpose of the Node.js 'cluster' module?",
        "options": ["To organize code into reusable components", "To enable horizontal scaling across multiple servers", "To create multiple processes that share server ports", "To improve database connection pooling"],
        "correctOptionIndex": 2,
        "correctOptionText": "To create multiple processes that share server ports",
        "difficulty": "medium",
        "explanation": "The cluster module allows you to create child processes (workers) that share the same server port, enabling a Node.js application to take advantage of multi-core systems and improve performance through load balancing.",
        "hint": "Think about how a single Node.js instance normally uses just one CPU core."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "Which module would you use to create a separate thread for CPU-intensive operations in Node.js?",
        "options": ["child_process", "threads", "worker_threads", "async_workers"],
        "correctOptionIndex": 2,
        "correctOptionText": "worker_threads",
        "difficulty": "medium",
        "explanation": "The worker_threads module allows creating threads that execute JavaScript in parallel, sharing memory through SharedArrayBuffer or by cloning and transferring data, making it ideal for CPU-intensive tasks.",
        "hint": "This module was introduced to allow true multithreaded programming in Node.js."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the difference between a Readable stream and a Transform stream?",
        "options": ["Readable streams can only read, Transform streams can read and write", "Readable streams are faster than Transform streams", "Readable streams are for files, Transform streams are for networks", "There is no difference"],
        "correctOptionIndex": 0,
        "correctOptionText": "Readable streams can only read, Transform streams can read and write",
        "difficulty": "medium",
        "explanation": "A Readable stream is a source from which data can be consumed, while a Transform stream is both readable and writable, allowing it to modify or transform data as it passes through from a readable source to a writable destination.",
        "hint": "Think about the capabilities of each stream type in terms of data flow direction."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the purpose of the 'v8' module in Node.js?",
        "options": ["To manage database connections", "To interact with the V8 JavaScript engine", "To handle HTTP responses", "To create virtual machines"],
        "correctOptionIndex": 1,
        "correctOptionText": "To interact with the V8 JavaScript engine",
        "difficulty": "medium",
        "explanation": "The v8 module provides interfaces to the V8 JavaScript engine that powers Node.js, allowing you to access information about heap usage, adjust memory limits, create heap snapshots, and more.",
        "hint": "Think about which engine powers JavaScript execution in Node.js."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is a Node.js C++ addon?",
        "options": ["A GUI framework for Node.js", "A browser extension for Node.js debugging", "A module written in C++ that can be loaded into Node.js", "A tool for memory profiling"],
        "correctOptionIndex": 2,
        "correctOptionText": "A module written in C++ that can be loaded into Node.js",
        "difficulty": "hard",
        "explanation": "Node.js C++ addons are dynamically-linked shared objects written in C++ that can be loaded into Node.js using the require() function. They behave like regular Node.js modules but offer higher performance and access to system-level functionality.",
        "hint": "These allow developers to extend Node.js capabilities using another programming language."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "Which of the following is true about Node.js streams?",
        "options": ["Streams can only process string data", "All streams are synchronous", "Streams process data sequentially in chunks", "Streams require the entire data to be loaded in memory"],
        "correctOptionIndex": 2,
        "correctOptionText": "Streams process data sequentially in chunks",
        "difficulty": "easy",
        "explanation": "Streams in Node.js process data sequentially in chunks, allowing handling of large amounts of data efficiently without loading everything into memory at once, which is ideal for tasks like file reading/writing and network communications.",
        "hint": "Think about how streams handle data compared to traditional methods."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the purpose of the 'Buffer' class in Node.js?",
        "options": ["To create temporary file storage", "To work with binary data directly", "To buffer network requests during high load", "To cache database query results"],
        "correctOptionIndex": 1,
        "correctOptionText": "To work with binary data directly",
        "difficulty": "easy",
        "explanation": "The Buffer class in Node.js is designed to handle binary data directly. It provides a way to work with streams of binary data and perform operations on raw memory allocations outside the V8 heap.",
        "hint": "This class was introduced because JavaScript originally lacked efficient binary data handling."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What does the 'promisify' function in the 'util' module do?",
        "options": ["Creates new promises", "Converts callback-based functions to promise-based functions", "Makes all async operations synchronous", "Improves promise performance"],
        "correctOptionIndex": 1,
        "correctOptionText": "Converts callback-based functions to promise-based functions",
        "difficulty": "medium",
        "explanation": "util.promisify() takes a function that follows the common Node.js callback pattern (error as first argument, result as second) and returns a version that returns a promise, making it easier to use with async/await.",
        "hint": "This helper transforms functions from one common asynchronous pattern to another."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "Which feature allows sharing memory between different worker threads?",
        "options": ["SharedMemory", "ArrayBuffer", "SharedArrayBuffer", "ThreadMemory"],
        "correctOptionIndex": 2,
        "correctOptionText": "SharedArrayBuffer",
        "difficulty": "hard",
        "explanation": "SharedArrayBuffer provides a way to create a fixed-length raw binary data buffer that can be shared between multiple worker threads, allowing them to read from and write to the same memory locations.",
        "hint": "This object was specifically designed for concurrent access from multiple threads."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is a microtask in Node.js event loop?",
        "options": ["A small function that executes quickly", "A task processed immediately after the current operation completes", "A low-priority background task", "A task that requires minimal memory"],
        "correctOptionIndex": 1,
        "correctOptionText": "A task processed immediately after the current operation completes",
        "difficulty": "hard",
        "explanation": "Microtasks are tasks that are executed immediately after the current operation completes, but before the event loop continues. Promise callbacks and process.nextTick callbacks are examples of microtasks in Node.js.",
        "hint": "These have higher priority than regular tasks in the event loop phases."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the purpose of the 'zlib' module in Node.js?",
        "options": ["Database compression", "In-memory caching", "File compression and decompression", "Network packet compression"],
        "correctOptionIndex": 2,
        "correctOptionText": "File compression and decompression",
        "difficulty": "medium",
        "explanation": "The zlib module provides compression functionality through Gzip, Deflate/Inflate, and Brotli implementations. It can be used to compress and decompress files, network streams, and other data sources.",
        "hint": "This module implements several industry-standard compression algorithms."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "Which of the following is NOT a phase in the Node.js event loop?",
        "options": ["timers", "poll", "check", "execute"],
        "correctOptionIndex": 3,
        "correctOptionText": "execute",
        "difficulty": "hard",
        "explanation": "The Node.js event loop consists of phases: timers (setTimeout/setInterval callbacks), pending callbacks (I/O callbacks), idle/prepare (internal use), poll (I/O events), check (setImmediate callbacks), and close callbacks. There is no 'execute' phase.",
        "hint": "The event loop has specific named phases for different types of operations."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the purpose of the 'VM' module in Node.js?",
        "options": ["To create virtual machines", "To run code in a different V8 context", "To sandbox untrusted code", "To simulate different Node.js versions"],
        "correctOptionIndex": 2,
        "correctOptionText": "To sandbox untrusted code",
        "difficulty": "hard",
        "explanation": "The VM (Virtual Machine) module in Node.js provides a way to compile and run code within a sandboxed V8 context. This allows running potentially untrusted code with some level of isolation from the main application.",
        "hint": "This module helps with executing code with controlled access to the surrounding environment."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "Which method would you use to fork a new Node.js process?",
        "options": ["process.fork()", "child_process.fork()", "cluster.fork()", "thread.fork()"],
        "correctOptionIndex": 1,
        "correctOptionText": "child_process.fork()",
        "difficulty": "medium",
        "explanation": "child_process.fork() is a special case of child_process.spawn() that spawns a new Node.js process and establishes an IPC communication channel between the parent and child, allowing messages to be passed back and forth.",
        "hint": "This method specifically creates new Node.js processes with communication channels."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the difference between process.nextTick() and setImmediate()?",
        "options": ["They are identical in functionality", "nextTick runs before I/O callbacks, setImmediate runs after", "nextTick is deprecated, setImmediate is the recommended approach", "nextTick is for synchronous operations, setImmediate is for asynchronous ones"],
        "correctOptionIndex": 1,
        "correctOptionText": "nextTick runs before I/O callbacks, setImmediate runs after",
        "difficulty": "hard",
        "explanation": "process.nextTick() callbacks run after the current operation completes, before the event loop continues (even before other microtasks). setImmediate() callbacks run in the check phase of the event loop, after I/O callbacks.",
        "hint": "These methods execute at different points in the event loop cycle."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "Which of the following is true about Node.js Worker Threads?",
        "options": ["They share memory by default", "They can only communicate via IPC", "They run in completely separate processes", "They allow parallel JavaScript execution in the same process"],
        "correctOptionIndex": 3,
        "correctOptionText": "They allow parallel JavaScript execution in the same process",
        "difficulty": "medium",
        "explanation": "Worker Threads in Node.js allow running JavaScript in parallel within the same process. Unlike child processes, they can share memory using SharedArrayBuffer and transfer structured data using MessagePort.",
        "hint": "Think about how Worker Threads differ from the cluster module's approach."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What does the 'crypto' module in Node.js provide?",
        "options": ["Cryptocurrency mining capabilities", "Database encryption", "Cryptographic functionality", "Secure socket connections"],
        "correctOptionIndex": 2,
        "correctOptionText": "Cryptographic functionality",
        "difficulty": "easy",
        "explanation": "The crypto module provides cryptographic functionality including a set of wrappers for OpenSSL's hash, HMAC, cipher, decipher, sign, and verify functions, enabling encryption, decryption, hashing, and more.",
        "hint": "This module includes tools for securing data and communications."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the purpose of the 'AsyncLocalStorage' class in Node.js?",
        "options": ["To store data on disk asynchronously", "To maintain context across asynchronous calls", "To provide async versions of localStorage API", "To create local caches for async operations"],
        "correctOptionIndex": 1,
        "correctOptionText": "To maintain context across asynchronous calls",
        "difficulty": "hard",
        "explanation": "AsyncLocalStorage provides a way to create asynchronous state that flows through the application, maintaining context across asynchronous operations without explicitly passing it as parameters, similar to thread-local storage in other languages.",
        "hint": "This feature helps solve a common problem with tracking request context in asynchronous server applications."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "Which statement about Node.js Streams backpressure is correct?",
        "options": ["It increases data processing speed", "It's a security mechanism to prevent data leaks", "It's a flow control mechanism when writing is slower than reading", "It compresses data to save memory"],
        "correctOptionIndex": 2,
        "correctOptionText": "It's a flow control mechanism when writing is slower than reading",
        "difficulty": "hard",
        "explanation": "Backpressure in Node.js streams is a mechanism that regulates the speed of data flowing through a pipeline when the destination can't process data as quickly as the source produces it, preventing memory overflow issues.",
        "hint": "This helps manage scenarios where data is being produced faster than it can be consumed."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the 'N-API' in Node.js?",
        "options": ["A new HTTP API", "An API for neural networks", "A stable API for building native addons", "A networking protocol implementation"],
        "correctOptionIndex": 2,
        "correctOptionText": "A stable API for building native addons",
        "difficulty": "hard",
        "explanation": "N-API (Node API) is an API for building native addons that is independent from the underlying JavaScript runtime (V8) and is maintained as part of Node.js. It's designed to insulate addons from changes in the JavaScript engine.",
        "hint": "This API helps solve the problem of native modules breaking with Node.js version updates."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "Which Node.js feature would you use to capture and handle all uncaught exceptions?",
        "options": ["try/catch blocks", "promise.catch()", "process.on('uncaughtException')", "global.errorHandler()"],
        "correctOptionIndex": 2,
        "correctOptionText": "process.on('uncaughtException')",
        "difficulty": "medium",
        "explanation": "The process.on('uncaughtException') event handler can be used to catch and handle exceptions that weren't caught by try/catch blocks and would otherwise crash the Node.js process.",
        "hint": "This is a global event that catches exceptions that would otherwise terminate the process."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the main advantage of using the 'http2' module over 'http'?",
        "options": ["Simplified API", "Multiplexed streams over a single connection", "Better security by default", "Reduced memory usage"],
        "correctOptionIndex": 1,
        "correctOptionText": "Multiplexed streams over a single connection",
        "difficulty": "medium",
        "explanation": "The HTTP/2 protocol, implemented in Node.js's http2 module, allows multiple request and response messages to be in flight simultaneously over a single connection, reducing latency and improving network efficiency compared to HTTP/1.1.",
        "hint": "This protocol feature significantly reduces the overhead of establishing multiple connections."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the purpose of the 'diagnostics_channel' module in Node.js?",
        "options": ["To diagnose hardware issues", "To provide a way to create named channels for diagnostics information", "To automatically fix common Node.js errors", "To monitor network connectivity"],
        "correctOptionIndex": 1,
        "correctOptionText": "To provide a way to create named channels for diagnostics information",
        "difficulty": "hard",
        "explanation": "The diagnostics_channel module provides an API to create named channels for diagnostics information, allowing application code to publish and subscribe to such channels without tight coupling between producers and consumers.",
        "hint": "This module enables more modular approaches to monitoring and diagnostics."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the main purpose of the 'inspector' module in Node.js?",
        "options": ["To inspect file systems", "To enable security inspections", "To provide an interface to the V8 inspector", "To validate input data"],
        "correctOptionIndex": 2,
        "correctOptionText": "To provide an interface to the V8 inspector",
        "difficulty": "hard",
        "explanation": "The inspector module provides an API for interacting with the V8 inspector, allowing developers to programmatically control the debugging and profiling features typically accessed through Chrome DevTools or other compatible tools.",
        "hint": "This module deals with debugging capabilities of the underlying JavaScript engine."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What happens when you call process.exit() in a Node.js application?",
        "options": ["The current function exits", "The current module stops executing", "The entire Node.js process terminates immediately", "A new process starts while the current one continues"],
        "correctOptionIndex": 2,
        "correctOptionText": "The entire Node.js process terminates immediately",
        "difficulty": "easy",
        "explanation": "process.exit() instructs Node.js to terminate the process immediately, with an exit code provided as an argument. This forcefully ends all operations, including pending callbacks and unfinished I/O operations.",
        "hint": "This is used when you need to stop program execution completely."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "Which module would you use to create a WebSocket server in Node.js?",
        "options": ["http", "ws", "socket.io", "websocket"],
        "correctOptionIndex": 1,
        "correctOptionText": "ws",
        "difficulty": "medium",
        "explanation": "The 'ws' module is a popular and well-maintained WebSocket client and server implementation for Node.js, providing a simple API for creating WebSocket servers and handling WebSocket connections.",
        "hint": "This is one of the most widely used libraries for WebSocket implementation in Node.js."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the purpose of 'node:' protocol in require statements?",
        "options": ["To load remote modules from a URL", "To explicitly load built-in Node.js modules", "To load modules using HTTP", "To load secure, signed modules only"],
        "correctOptionIndex": 1,
        "correctOptionText": "To explicitly load built-in Node.js modules",
        "difficulty": "medium",
        "explanation": "The 'node:' protocol in require statements (e.g., require('node:fs')) is used to explicitly indicate that you're loading a built-in Node.js module, preventing potential conflicts with similarly named modules in node_modules.",
        "hint": "This was introduced to make it clear when you're using core modules versus third-party modules."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "How can you debug memory leaks in a Node.js application?",
        "options": ["Using console.log statements", "Using the --inspect flag and Chrome DevTools", "Restarting the application regularly", "Adding more memory to the server"],
        "correctOptionIndex": 1,
        "correctOptionText": "Using the --inspect flag and Chrome DevTools",
        "difficulty": "medium",
        "explanation": "Memory leaks in Node.js applications can be debugged by starting the application with the --inspect flag and using Chrome DevTools to take and analyze heap snapshots, identifying objects that aren't being garbage collected properly.",
        "hint": "This approach gives you visualization tools to see memory usage patterns over time."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the purpose of the 'performance' module in Node.js?",
        "options": ["To improve application performance automatically", "To measure the duration of operations with high-resolution timing", "To generate performance reports", "To compare performance between different Node.js versions"],
        "correctOptionIndex": 1,
        "correctOptionText": "To measure the duration of operations with high-resolution timing",
        "difficulty": "medium",
        "explanation": "The performance module (perf_hooks) provides an implementation of the W3C Performance API, allowing high-resolution timing measurements of specific operations in an application, which is useful for performance monitoring and optimization.",
        "hint": "This module helps answer questions about how long certain operations take."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What does the 'async_hooks' module allow you to do?",
        "options": ["Create asynchronous functions automatically", "Track the lifetime of asynchronous resources", "Convert synchronous code to asynchronous", "Manage hook functions for APIs"],
        "correctOptionIndex": 1,
        "correctOptionText": "Track the lifetime of asynchronous resources",
        "difficulty": "hard",
        "explanation": "The async_hooks module provides an API to track asynchronous resources throughout their lifecycle, from creation to destruction. This allows for better debugging, monitoring, and understanding of asynchronous operations in complex applications.",
        "hint": "This module helps track relationships between asynchronous operations."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Advanced Topics",
        "questionText": "What is the difference between the 'child_process.spawn()' and 'child_process.exec()' methods?",
        "options": ["There is no difference", "spawn() is asynchronous, exec() is synchronous", "spawn() streams data, exec() buffers data", "spawn() is for Node.js processes only, exec() is for any process"],
        "correctOptionIndex": 2,
        "correctOptionText": "spawn() streams data, exec() buffers data",
        "difficulty": "hard",
        "explanation": "child_process.spawn() returns streams for stdout and stderr, allowing data to be processed as it arrives. child_process.exec() buffers all output and passes complete buffers to a callback when the process exits, which is less efficient for large outputs.",
        "hint": "Think about how these methods handle the output from the child process."
    },
    ...
    // Performance Optimization
    {
        ...
        "questionText": "Which of the following is NOT a valid method to improve Node.js application performance?",
        "options": ["Caching frequently accessed data", "Using worker threads for CPU-intensive tasks", "Running synchronous operations in the main thread", "Implementing load balancing"],
        "correctOptionIndex": 2,
        "correctOptionText": "Running synchronous operations in the main thread",
        "difficulty": "easy",
        "explanation": "Running synchronous operations in the main thread blocks the event loop, which significantly degrades Node.js performance. Always use asynchronous operations for I/O tasks.",
        "hint": "Think about what would block Node.js's event loop."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which Node.js module is specifically designed for measuring code execution time?",
        "options": ["performance-now", "benchmark", "perf_hooks", "time-tracker"],
        "correctOptionIndex": 2,
        "correctOptionText": "perf_hooks",
        "difficulty": "medium",
        "explanation": "The 'perf_hooks' module in Node.js provides performance measurement APIs, including the Performance Timeline API and high-resolution time measurement.",
        "hint": "This built-in module was introduced to bring Web Performance API timing features to Node.js."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What is the primary benefit of using the 'cluster' module in Node.js?",
        "options": ["Reduced memory usage", "Improved database connectivity", "Load balancing across multiple CPU cores", "Enhanced security features"],
        "correctOptionIndex": 2,
        "correctOptionText": "Load balancing across multiple CPU cores",
        "difficulty": "medium",
        "explanation": "The cluster module allows a Node.js application to spawn worker processes that all share the same server port, distributing incoming connections across multiple CPU cores for improved performance.",
        "hint": "Node.js is single-threaded; this module helps utilize all available CPU cores."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which of the following is an effective way to reduce memory usage in a Node.js application?",
        "options": ["Increasing the heap size", "Using streams for large data processing", "Loading all data into memory at startup", "Disabling garbage collection"],
        "correctOptionIndex": 1,
        "correctOptionText": "Using streams for large data processing",
        "difficulty": "easy",
        "explanation": "Streams allow processing data piece by piece without loading the entire dataset into memory, which is crucial for handling large files or datasets efficiently.",
        "hint": "Think about processing data sequentially rather than all at once."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What does the `--inspect` flag do when running a Node.js application?",
        "options": ["Enables security inspection", "Starts the application with debugging enabled", "Checks code quality", "Performs automated testing"],
        "correctOptionIndex": 1,
        "correctOptionText": "Starts the application with debugging enabled",
        "difficulty": "easy",
        "explanation": "The `--inspect` flag starts the Node.js process with the inspector protocol enabled, allowing you to debug your application using Chrome DevTools or other compatible tools.",
        "hint": "This flag is related to troubleshooting application issues."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which command would you use to profile CPU usage in a Node.js application?",
        "options": ["node --prof app.js", "node --cpu-profile app.js", "node --performance app.js", "node --analyze app.js"],
        "correctOptionIndex": 0,
        "correctOptionText": "node --prof app.js",
        "difficulty": "medium",
        "explanation": "The `--prof` flag enables the V8 profiler which generates a log file that can be processed using the `--prof-process` flag to analyze CPU usage.",
        "hint": "This flag enables V8's built-in sampling profiler."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What is the purpose of the `NODE_ENV=production` environment variable?",
        "options": ["It enables production-level logging", "It activates additional security features", "It optimizes Node.js for performance", "It enables deployment to production servers"],
        "correctOptionIndex": 2,
        "correctOptionText": "It optimizes Node.js for performance",
        "difficulty": "easy",
        "explanation": "Setting `NODE_ENV=production` enables various optimizations in Node.js and frameworks like Express. It typically disables development features, reduces logging, and enables caching for better performance.",
        "hint": "This environment variable affects how frameworks like Express behave in terms of optimization."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which of the following is a memory leak in a Node.js application?",
        "options": ["Using event emitters with proper cleanup", "Implementing garbage collection", "Adding event listeners without removing them", "Using async/await patterns"],
        "correctOptionIndex": 2,
        "correctOptionText": "Adding event listeners without removing them",
        "difficulty": "medium",
        "explanation": "When event listeners are added but never removed (especially in code that runs repeatedly), they accumulate and prevent objects from being garbage collected, causing memory leaks.",
        "hint": "Think about resources that need to be cleaned up but might be forgotten."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What does the term 'hot path' refer to in performance optimization?",
        "options": ["Code that causes memory leaks", "Code that is rarely executed", "Code that executes frequently", "Code that overheats the CPU"],
        "correctOptionIndex": 2,
        "correctOptionText": "Code that executes frequently",
        "difficulty": "medium",
        "explanation": "A 'hot path' refers to sections of code that are executed very frequently. Optimizing hot paths provides the greatest performance benefits because they have the largest impact on overall application performance.",
        "hint": "This term relates to the frequency of code execution."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which built-in Node.js tool helps analyze memory snapshots to find memory leaks?",
        "options": ["Memory Analyzer", "Heap Profiler", "Garbage Collector", "Memory Inspector"],
        "correctOptionIndex": 1,
        "correctOptionText": "Heap Profiler",
        "difficulty": "medium",
        "explanation": "Node.js includes a Heap Profiler that can take memory snapshots, allowing developers to analyze memory usage patterns and identify potential memory leaks.",
        "hint": "This tool examines JavaScript objects in memory at specific points in time."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What technique can help reduce the cold start time of a Node.js serverless function?",
        "options": ["Increasing function memory allocation", "Using worker threads", "Implementing connection pooling", "Reducing dependency size"],
        "correctOptionIndex": 3,
        "correctOptionText": "Reducing dependency size",
        "difficulty": "hard",
        "explanation": "Cold start time in serverless functions is significantly affected by the size of the deployment package. Reducing dependencies and using lightweight libraries helps minimize initialization time.",
        "hint": "Think about what needs to be loaded when a serverless function first initializes."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which of the following is most effective for optimizing database queries in a Node.js application?",
        "options": ["Running all queries synchronously", "Using raw SQL instead of ORMs", "Implementing proper indexing", "Always retrieving all table columns"],
        "correctOptionIndex": 2,
        "correctOptionText": "Implementing proper indexing",
        "difficulty": "medium",
        "explanation": "Proper database indexing significantly improves query performance by allowing the database to find requested rows quickly without scanning the entire table.",
        "hint": "This technique helps databases locate data more efficiently."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What is the `--zero-fill-buffers` flag used for in Node.js?",
        "options": ["Optimizing memory usage", "Initializing buffers with zeros for security", "Reducing buffer size", "Improving buffer allocation speed"],
        "correctOptionIndex": 1,
        "correctOptionText": "Initializing buffers with zeros for security",
        "difficulty": "hard",
        "explanation": "The `--zero-fill-buffers` flag forces all newly allocated Buffer instances to be zero-filled, which can prevent potential security issues by ensuring no previous memory data is exposed but comes with a performance cost.",
        "hint": "This flag addresses a security concern related to uninitialized memory."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What does the 'backpressure' concept refer to in Node.js streams?",
        "options": ["A security mechanism", "A way to compress data", "A mechanism to handle flow control when writing data is slower than reading", "A technique to increase stream throughput"],
        "correctOptionIndex": 2,
        "correctOptionText": "A mechanism to handle flow control when writing data is slower than reading",
        "difficulty": "hard",
        "explanation": "Backpressure is a flow control mechanism in streams that prevents memory overflow by ensuring that a fast readable stream doesn't overwhelm a slower writable stream, by pausing reading until the writer catches up.",
        "hint": "This handles scenarios where data is being produced faster than it can be consumed."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which method is NOT recommended for parsing JSON in high-performance Node.js applications?",
        "options": ["Using JSON.parse()", "Using a streaming JSON parser", "Using eval() on JSON strings", "Using specialized JSON libraries"],
        "correctOptionIndex": 2,
        "correctOptionText": "Using eval() on JSON strings",
        "difficulty": "medium",
        "explanation": "Using eval() to parse JSON is extremely dangerous as it executes any code in the string, creating security vulnerabilities. It's also typically slower than JSON.parse().",
        "hint": "Think about security implications when parsing data from external sources."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What is the maximum size of the Node.js call stack by default?",
        "options": ["1MB", "8MB", "10MB", "Unlimited"],
        "correctOptionIndex": 0,
        "correctOptionText": "1MB",
        "difficulty": "hard",
        "explanation": "The default maximum call stack size in Node.js is approximately 1MB. Exceeding this limit results in a 'Maximum call stack size exceeded' error, often due to infinite recursion.",
        "hint": "This limit affects how deep function call nesting can go before causing errors."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which technique helps reduce the impact of garbage collection pauses in Node.js?",
        "options": ["Disabling garbage collection", "Increasing memory allocation", "Writing memory-efficient code with fewer allocations", "Running garbage collection manually"],
        "correctOptionIndex": 2,
        "correctOptionText": "Writing memory-efficient code with fewer allocations",
        "difficulty": "medium",
        "explanation": "Reducing the number of object allocations and promoting object reuse leads to less garbage collection work, which minimizes the frequency and duration of GC pauses that can affect application responsiveness.",
        "hint": "Think about what triggers garbage collection in the first place."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What is 'memoization' in the context of Node.js performance optimization?",
        "options": ["Storing logs of application performance", "Technique to reduce database queries", "Caching the results of expensive function calls", "Method to analyze memory usage"],
        "correctOptionIndex": 2,
        "correctOptionText": "Caching the results of expensive function calls",
        "difficulty": "medium",
        "explanation": "Memoization is an optimization technique that stores the results of expensive function calls and returns the cached result when the same inputs occur again, avoiding redundant computation.",
        "hint": "This technique is particularly useful for pure functions with repetitive inputs."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which component of Node.js is responsible for scheduling timers and processing the event loop?",
        "options": ["V8 engine", "libuv", "npm", "Node Package Manager"],
        "correctOptionIndex": 1,
        "correctOptionText": "libuv",
        "difficulty": "medium",
        "explanation": "libuv is the library that provides the event loop, thread pool, and asynchronous I/O for Node.js. It's responsible for scheduling timers and handling the event-driven architecture.",
        "hint": "This C library handles the asynchronous I/O operations across different operating systems."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What is the purpose of the `--trace-warnings` flag in Node.js?",
        "options": ["To disable all warnings", "To show stack traces for warnings", "To trace memory allocation", "To track network requests"],
        "correctOptionIndex": 1,
        "correctOptionText": "To show stack traces for warnings",
        "difficulty": "medium",
        "explanation": "The `--trace-warnings` flag prints stack traces for process warnings (including deprecated APIs), helping developers identify exactly where problematic code is located.",
        "hint": "This flag helps provide more context about where warnings are occurring in your code."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which method is most efficient for concatenating multiple strings in Node.js?",
        "options": ["Using the + operator in a loop", "Using array.join()", "Using string.concat() in a loop", "Using template literals in a loop"],
        "correctOptionIndex": 1,
        "correctOptionText": "Using array.join()",
        "difficulty": "medium",
        "explanation": "For concatenating multiple strings, array.join() is generally more efficient than repeated string concatenation operations because strings are immutable, and each concatenation creates a new string object.",
        "hint": "Think about how strings are handled in memory and which approach minimizes new string creation."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What does the 'V8.serialize()' method do in Node.js?",
        "options": ["Optimizes database queries", "Converts JavaScript objects to a binary format", "Serializes HTTP requests", "Compresses large files"],
        "correctOptionIndex": 1,
        "correctOptionText": "Converts JavaScript objects to a binary format",
        "difficulty": "hard",
        "explanation": "V8.serialize() converts JavaScript values to a binary format which can be stored or transmitted and later deserialized. It's more efficient than JSON for binary data and preserves more data types.",
        "hint": "This method provides a more efficient alternative to JSON.stringify() for certain use cases."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which of the following is a benefit of HTTP/2 support in Node.js?",
        "options": ["Reduced security features", "Single connection for multiple requests", "Larger header sizes", "Mandatory TLS encryption"],
        "correctOptionIndex": 1,
        "correctOptionText": "Single connection for multiple requests",
        "difficulty": "medium",
        "explanation": "HTTP/2 enables multiplexing, allowing multiple requests and responses to be sent over a single connection simultaneously, reducing overhead and improving performance compared to HTTP/1.1.",
        "hint": "Think about connection establishment overhead in HTTP/1.1 versus HTTP/2."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What is the purpose of the 'autocannon' tool in Node.js development?",
        "options": ["Automatic code generation", "HTTP/HTTPS benchmarking", "Memory leak detection", "SQL query optimization"],
        "correctOptionIndex": 1,
        "correctOptionText": "HTTP/HTTPS benchmarking",
        "difficulty": "medium",
        "explanation": "Autocannon is a high-performance HTTP/HTTPS benchmarking tool written in Node.js, used to measure how many requests per second a HTTP/HTTPS server can handle.",
        "hint": "This tool helps developers understand how their server performs under load."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which of the following is NOT a valid way to profile a Node.js application?",
        "options": ["Using Chrome DevTools", "Using the built-in --prof flag", "Using third-party tools like clinic.js", "Setting NODE_DEBUG=profile"],
        "correctOptionIndex": 3,
        "correctOptionText": "Setting NODE_DEBUG=profile",
        "difficulty": "hard",
        "explanation": "NODE_DEBUG is used for debugging specific Node.js core modules (like http, net, etc.), but there is no 'profile' option for it. Profiling is done using other methods like --prof, Chrome DevTools, or third-party tools.",
        "hint": "NODE_DEBUG has specific valid values for core modules, but not for profiling."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What is the 'Keep-Alive' header used for in HTTP requests with Node.js?",
        "options": ["To prevent timeouts", "To keep the server running", "To reuse TCP connections", "To maintain user sessions"],
        "correctOptionIndex": 2,
        "correctOptionText": "To reuse TCP connections",
        "difficulty": "medium",
        "explanation": "The HTTP Keep-Alive header is used to maintain a persistent connection between client and server, allowing multiple requests to reuse the same TCP connection and avoid the overhead of establishing new connections.",
        "hint": "This feature reduces the latency associated with connection establishment."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which Node.js feature helps prevent 'callback hell' while improving code readability and maintenance?",
        "options": ["Event emitters", "Streams", "Async/await", "Process forking"],
        "correctOptionIndex": 2,
        "correctOptionText": "Async/await",
        "difficulty": "easy",
        "explanation": "Async/await syntax provides a cleaner way to work with Promises, making asynchronous code look and behave more like synchronous code, which improves readability and maintainability.",
        "hint": "This feature was introduced in Node.js 7.6 and allows writing asynchronous code in a synchronous style."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What does the '--expose-gc' flag do when running a Node.js application?",
        "options": ["Exposes security vulnerabilities", "Makes the garbage collector visible to Chrome DevTools", "Allows manual garbage collection through global.gc()", "Disables garbage collection entirely"],
        "correctOptionIndex": 2,
        "correctOptionText": "Allows manual garbage collection through global.gc()",
        "difficulty": "hard",
        "explanation": "The '--expose-gc' flag exposes the garbage collector to the Node.js process, allowing you to manually trigger garbage collection by calling global.gc() in your code, which can be useful for testing and benchmarking.",
        "hint": "This flag gives developers programmatic control over a process that's normally automatic."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "Which of the following best describes the 'strace' tool's use in Node.js performance analysis?",
        "options": ["It profiles CPU usage in the V8 engine", "It traces system calls made by the Node.js process", "It analyzes memory allocation patterns", "It monitors the event loop timing"],
        "correctOptionIndex": 1,
        "correctOptionText": "It traces system calls made by the Node.js process",
        "difficulty": "hard",
        "explanation": "strace is a diagnostic tool for Linux that traces system calls and signals. When used with Node.js, it helps identify which system calls are being made and how much time is spent in kernel space vs. user space.",
        "hint": "This Linux utility helps understand how an application interacts with the operating system."
    },
    {
        "topic": "67dec085269789799b76ef03",
        "module": "Performance Optimization",
        "questionText": "What is the main purpose of using Web Workers in Node.js?",
        "options": ["To create separate processes", "To offload CPU-intensive tasks from the main thread", "To handle HTTP requests", "To optimize database queries"],
        "correctOptionIndex": 1,
        "correctOptionText": "To offload CPU-intensive tasks from the main thread",
        "difficulty": "medium",
        "explanation": "Web Workers (implemented in Node.js via worker_threads) allow running JavaScript in parallel threads, which helps offload CPU-intensive tasks from the main event loop, preventing it from being blocked.",
        "hint": "These help maintain application responsiveness during computationally heavy operations."
    },
