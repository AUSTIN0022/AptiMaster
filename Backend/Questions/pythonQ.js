const pythonQuestions = [
    ...
    // Data Visualization
    {
        ...
        "questionText": "Which matplotlib function creates a simple line plot?",
        "options": ["plt.line()", "plt.plot()", "plt.linechart()", "plt.draw()"],
        "correctOptionIndex": 1,
        "correctOptionText": "plt.plot()",
        "difficulty": "easy",
        "explanation": "The `plt.plot()` function is used to create a simple line plot in matplotlib.",
        "hint": "This is the most basic plotting function in matplotlib."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "How do you add a title to a matplotlib plot?",
        "options": ["plt.title('My Title')", "plt.name('My Title')", "plt.header('My Title')", "plt.label('My Title')"],
        "correctOptionIndex": 0,
        "correctOptionText": "plt.title('My Title')",
        "difficulty": "easy",
        "explanation": "The `plt.title()` function is used to add a title to a matplotlib plot.",
        "hint": "The function name directly corresponds to the element you're adding to the plot."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which of the following is NOT a visualization library in Python?",
        "options": ["matplotlib", "seaborn", "plotly", "pandasql"],
        "correctOptionIndex": 3,
        "correctOptionText": "pandasql",
        "difficulty": "easy",
        "explanation": "Pandasql is a library for running SQL queries on pandas DataFrames, not a visualization library. Matplotlib, Seaborn, and Plotly are all visualization libraries.",
        "hint": "Think about which library is used for data manipulation rather than visualization."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which function would you use to create a scatter plot in matplotlib?",
        "options": ["plt.scatter()", "plt.points()", "plt.dots()", "plt.scatterplot()"],
        "correctOptionIndex": 0,
        "correctOptionText": "plt.scatter()",
        "difficulty": "easy",
        "explanation": "The `plt.scatter()` function is used to create a scatter plot in matplotlib, which displays the relationship between two variables as points.",
        "hint": "The function name directly describes the type of plot it creates."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What is the role of the `figsize` parameter in `plt.figure()`?",
        "options": ["Sets the size of the figure in inches", "Sets the number of subplots", "Sets the resolution of the figure", "Sets the aspect ratio of the plot"],
        "correctOptionIndex": 0,
        "correctOptionText": "Sets the size of the figure in inches",
        "difficulty": "medium",
        "explanation": "The `figsize` parameter in `plt.figure()` sets the width and height of the figure in inches. It's typically passed as a tuple (width, height).",
        "hint": "Think about what aspect of the figure's appearance this parameter might control."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which seaborn function is specifically designed for visualizing the distribution of a single variable?",
        "options": ["sns.histplot()", "sns.lineplot()", "sns.scatterplot()", "sns.barplot()"],
        "correctOptionIndex": 0,
        "correctOptionText": "sns.histplot()",
        "difficulty": "medium",
        "explanation": "The `sns.histplot()` function in seaborn is designed for visualizing the distribution of a single variable using histograms.",
        "hint": "This plot type shows the frequency distribution of values in a dataset."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What is the main advantage of using seaborn over matplotlib?",
        "options": ["Seaborn provides higher-level interfaces for creating attractive statistical graphics", "Seaborn is faster than matplotlib", "Seaborn supports 3D plotting while matplotlib doesn't", "Seaborn works with pandas DataFrames while matplotlib doesn't"],
        "correctOptionIndex": 0,
        "correctOptionText": "Seaborn provides higher-level interfaces for creating attractive statistical graphics",
        "difficulty": "medium",
        "explanation": "Seaborn is built on top of matplotlib and provides higher-level interfaces that make it easier to create attractive and informative statistical graphics with less code.",
        "hint": "Think about the relationship between seaborn and matplotlib and what seaborn adds."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which type of plot is most appropriate for visualizing the relationship between two categorical variables?",
        "options": ["Heatmap", "Scatter plot", "Line plot", "Histogram"],
        "correctOptionIndex": 0,
        "correctOptionText": "Heatmap",
        "difficulty": "medium",
        "explanation": "A heatmap is most appropriate for visualizing the relationship between two categorical variables, as it can show the frequency or aggregated value for each combination of categories.",
        "hint": "Think about which plot type can effectively show patterns across two discrete dimensions."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What is the correct way to create a figure with multiple subplots in matplotlib?",
        "options": ["plt.subplots()", "plt.subplot()", "plt.multiplot()", "plt.gridplot()"],
        "correctOptionIndex": 0,
        "correctOptionText": "plt.subplots()",
        "difficulty": "medium",
        "explanation": "The `plt.subplots()` function is used to create a figure and a grid of subplots with a single call, returning the figure and the axes array.",
        "hint": "Note the plural form of this function name."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which of the following is NOT a valid color specification in matplotlib?",
        "options": ["'CSS:navy'", "'r'", "'#FF0000'", "'red'"],
        "correctOptionIndex": 0,
        "correctOptionText": "'CSS:navy'",
        "difficulty": "medium",
        "explanation": "While matplotlib supports various color formats including single letters ('r'), hex codes ('#FF0000'), and color names ('red'), the 'CSS:navy' format is not valid. CSS colors are specified directly by name or hex code.",
        "hint": "Consider the standard ways to specify colors in programming."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What does the `hue` parameter do in seaborn plotting functions?",
        "options": ["Maps a variable to color to create subgroups", "Adjusts the brightness of the plot", "Controls the size of plot elements", "Sets the color palette for the entire plot"],
        "correctOptionIndex": 0,
        "correctOptionText": "Maps a variable to color to create subgroups",
        "difficulty": "medium",
        "explanation": "In seaborn, the `hue` parameter maps a variable to different colors, creating visual subgroups in the plot. This allows you to visualize an additional dimension of data.",
        "hint": "Think about how this parameter might help you see patterns across different categories."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which function would you use to add a colorbar to a matplotlib plot?",
        "options": ["plt.colorbar()", "plt.cbar()", "plt.addcolorbar()", "plt.legend()"],
        "correctOptionIndex": 0,
        "correctOptionText": "plt.colorbar()",
        "difficulty": "medium",
        "explanation": "The `plt.colorbar()` function adds a colorbar to the current figure, which helps interpret the mapping between colors and values in plots like heatmaps or scatter plots with color mapping.",
        "hint": "The function name directly describes what it adds to the plot."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What is the purpose of `plt.savefig()` in matplotlib?",
        "options": ["To save the current figure to a file", "To save the current figure settings for future use", "To save the plot data for later analysis", "To save the current figure to the clipboard"],
        "correctOptionIndex": 0,
        "correctOptionText": "To save the current figure to a file",
        "difficulty": "easy",
        "explanation": "The `plt.savefig()` function saves the current figure to a file in various formats like PNG, PDF, SVG, etc.",
        "hint": "Think about what 'fig' is short for in this function name."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which seaborn function is used to create a violin plot?",
        "options": ["sns.violinplot()", "sns.violin()", "sns.vplot()", "sns.violplot()"],
        "correctOptionIndex": 0,
        "correctOptionText": "sns.violinplot()",
        "difficulty": "medium",
        "explanation": "The `sns.violinplot()` function creates violin plots, which show the distribution of data across categories. It combines aspects of box plots and kernel density plots.",
        "hint": "The function name directly reflects the type of plot it creates."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What is the purpose of the `alpha` parameter in matplotlib plotting functions?",
        "options": ["Controls the transparency of plot elements", "Sets the angle of the plot elements", "Adjusts the aspect ratio of the plot", "Controls the size of plot elements"],
        "correctOptionIndex": 0,
        "correctOptionText": "Controls the transparency of plot elements",
        "difficulty": "medium",
        "explanation": "The `alpha` parameter controls the transparency of plot elements, with values ranging from 0 (completely transparent) to 1 (completely opaque).",
        "hint": "In computer graphics, this parameter is commonly used to control how see-through elements are."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which seaborn function creates a plot that combines a histogram and a kernel density estimate?",
        "options": ["sns.displot()", "sns.histplot()", "sns.kdeplot()", "sns.densityplot()"],
        "correctOptionIndex": 0,
        "correctOptionText": "sns.displot()",
        "difficulty": "hard",
        "explanation": "The `sns.displot()` function creates a figure-level plot that can combine a histogram and kernel density estimate. It offers more flexibility than histplot() and provides a figure-level interface.",
        "hint": "This function's name hints at showing a distribution."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What is the difference between `plt.show()` and `plt.display()` in matplotlib?",
        "options": ["`plt.display()` is not a standard matplotlib function", "`plt.show()` is for interactive plots, `plt.display()` is for static plots", "`plt.show()` displays the plot immediately, `plt.display()` saves it for later", "`plt.show()` works in notebooks, `plt.display()` works in scripts"],
        "correctOptionIndex": 0,
        "correctOptionText": "`plt.display()` is not a standard matplotlib function",
        "difficulty": "medium",
        "explanation": "There is no standard `plt.display()` function in matplotlib. The `plt.show()` function is used to display all open figures and block execution until the figures are closed.",
        "hint": "Check which of these is actually part of the matplotlib API."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which plot type is most suitable for visualizing changes over time?",
        "options": ["Line plot", "Scatter plot", "Bar plot", "Pie chart"],
        "correctOptionIndex": 0,
        "correctOptionText": "Line plot",
        "difficulty": "easy",
        "explanation": "Line plots are most suitable for visualizing changes over time, as they clearly show trends and patterns in sequential data.",
        "hint": "Think about which plot type best represents continuous change along a dimension."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What is the purpose of the `plt.tight_layout()` function?",
        "options": ["Adjusts subplot parameters to give specified padding", "Makes the plot more condensed", "Changes the figure size to fit the content", "Aligns all plot elements to a grid"],
        "correctOptionIndex": 0,
        "correctOptionText": "Adjusts subplot parameters to give specified padding",
        "difficulty": "medium",
        "explanation": "The `plt.tight_layout()` function automatically adjusts subplot parameters to give specified padding between subplots and prevent overlapping of plot elements.",
        "hint": "This function helps solve a common issue with subplot labels and titles."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which seaborn function is used to create a pair plot?",
        "options": ["sns.pairplot()", "sns.pairgrid()", "sns.pairwise()", "sns.pairdist()"],
        "correctOptionIndex": 0,
        "correctOptionText": "sns.pairplot()",
        "difficulty": "medium",
        "explanation": "The `sns.pairplot()` function creates a grid of scatter plots for all pairs of variables in a dataset, with histograms or kernel density estimates on the diagonal.",
        "hint": "This is a common way to explore relationships between multiple variables at once."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What does the `plt.grid()` function do?",
        "options": ["Adds grid lines to the plot", "Creates a grid of subplots", "Adjusts the aspect ratio to a grid", "Snaps plot elements to a grid"],
        "correctOptionIndex": 0,
        "correctOptionText": "Adds grid lines to the plot",
        "difficulty": "easy",
        "explanation": "The `plt.grid()` function adds grid lines to the plot, which can help with reading values and comparing data points.",
        "hint": "Think about what visual element this might add to make plots easier to read."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which matplotlib function is used to create a histogram?",
        "options": ["plt.hist()", "plt.histogram()", "plt.bar()", "plt.distribution()"],
        "correctOptionIndex": 0,
        "correctOptionText": "plt.hist()",
        "difficulty": "easy",
        "explanation": "The `plt.hist()` function creates a histogram, which represents the distribution of a dataset by dividing it into bins and counting the number of observations in each bin.",
        "hint": "This function name is an abbreviated version of 'histogram'."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What is the purpose of the `plt.xlim()` and `plt.ylim()` functions?",
        "options": ["Set the limits of the x and y axes", "Label the x and y axes", "Scale the x and y axes", "Rotate the x and y axes"],
        "correctOptionIndex": 0,
        "correctOptionText": "Set the limits of the x and y axes",
        "difficulty": "medium",
        "explanation": "The `plt.xlim()` and `plt.ylim()` functions are used to set the minimum and maximum values for the x and y axes, respectively.",
        "hint": "Think about what 'lim' might be short for in these function names."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which of the following is NOT a valid matplotlib line style?",
        "options": ["'>-'", "'-'", "'--'", "':'"],
        "correctOptionIndex": 0,
        "correctOptionText": "'>-'",
        "difficulty": "medium",
        "explanation": "The string '>-' is not a valid matplotlib line style. Valid line styles include '-' (solid), '--' (dashed), '-.' (dash-dot), and ':' (dotted).",
        "hint": "Consider the standard line styles in plotting libraries."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What is the primary purpose of a box plot?",
        "options": ["To show the distribution and identify outliers", "To compare values across categories", "To show changes over time", "To display correlations between variables"],
        "correctOptionIndex": 0,
        "correctOptionText": "To show the distribution and identify outliers",
        "difficulty": "medium",
        "explanation": "Box plots (also known as box-and-whisker plots) are primarily used to show the distribution of data through quartiles and to identify outliers.",
        "hint": "Think about what information the 'box' and 'whiskers' represent in this type of plot."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which seaborn function creates a heatmap?",
        "options": ["sns.heatmap()", "sns.hmap()", "sns.colormap()", "sns.density()"],
        "correctOptionIndex": 0,
        "correctOptionText": "sns.heatmap()",
        "difficulty": "medium",
        "explanation": "The `sns.heatmap()` function creates a heatmap, which is a graphical representation of data where values are represented as colors.",
        "hint": "The function name directly describes the type of plot it creates."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What does the `sns.set_style()` function do?",
        "options": ["Sets the aesthetic style of the plots", "Sets the size of the plots", "Sets the color palette of the plots", "Sets the font style of the plots"],
        "correctOptionIndex": 0,
        "correctOptionText": "Sets the aesthetic style of the plots",
        "difficulty": "medium",
        "explanation": "The `sns.set_style()` function sets the aesthetic style of the plots, controlling elements like background color, grid lines, and axis spines.",
        "hint": "This function affects the overall look and feel of your visualizations."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which matplotlib function is used to create a pie chart?",
        "options": ["plt.pie()", "plt.piechart()", "plt.circle()", "plt.sector()"],
        "correctOptionIndex": 0,
        "correctOptionText": "plt.pie()",
        "difficulty": "easy",
        "explanation": "The `plt.pie()` function creates a pie chart, which shows the proportion of each category as a slice of a circle.",
        "hint": "The function name directly describes the type of chart it creates."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What is the purpose of `plt.legend()` in matplotlib?",
        "options": ["To add a legend to the plot", "To add a title to the plot", "To add annotations to the plot", "To add a footnote to the plot"],
        "correctOptionIndex": 0,
        "correctOptionText": "To add a legend to the plot",
        "difficulty": "easy",
        "explanation": "The `plt.legend()` function adds a legend to the plot, which helps identify different data series or categories.",
        "hint": "This helps viewers understand what different colors or markers represent in your plot."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "Which of the following is an interactive plotting library in Python?",
        "options": ["Plotly", "Matplotlib", "Seaborn", "Pandas"],
        "correctOptionIndex": 0,
        "correctOptionText": "Plotly",
        "difficulty": "medium",
        "explanation": "Plotly is an interactive plotting library in Python that allows users to create interactive, publication-quality graphs for web applications.",
        "hint": "Think about which library is known for its interactive features like zooming and hovering."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Data Visualization",
        "questionText": "What is a choropleth map?",
        "options": ["A map that uses color to represent a statistical variable", "A map that shows the distribution of points", "A map that connects points with lines", "A map that displays terrain features"],
        "correctOptionIndex": 0,
        "correctOptionText": "A map that uses color to represent a statistical variable",
        "difficulty": "hard",
        "explanation": "A choropleth map uses color to represent a statistical variable across predefined regions, such as countries, states, or counties.",
        "hint": "Think about maps that show demographics or election results with different colored regions."
    },

    // Web Development with Python
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "Which Python web framework is known for its simplicity and is often called a 'microframework'?",
        "options": ["Django", "Flask", "Pyramid", "Tornado"],
        "correctOptionIndex": 1,
        "correctOptionText": "Flask",
        "difficulty": "easy",
        "explanation": "Flask is a lightweight WSGI web application framework designed to make getting started quick and easy, with the ability to scale up to complex applications. It's often referred to as a 'microframework' because it doesn't require particular tools or libraries.",
        "hint": "This framework focuses on simplicity with a small core and is extensible through various extensions."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "In Django, what is the primary file used to define URL patterns?",
        "options": ["models.py", "views.py", "urls.py", "settings.py"],
        "correctOptionIndex": 2,
        "correctOptionText": "urls.py",
        "difficulty": "easy",
        "explanation": "In Django, the urls.py file is used to define URL patterns that map to views. It's where you specify which view should handle which URL pattern.",
        "hint": "This file contains patterns that map URLs to view functions."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "Which HTTP method is typically used to request data from a specified resource?",
        "options": ["GET", "POST", "PUT", "DELETE"],
        "correctOptionIndex": 0,
        "correctOptionText": "GET",
        "difficulty": "easy",
        "explanation": "The GET method is used to request data from a specified resource. It's one of the most common HTTP methods and is designed to retrieve data without causing any side effects.",
        "hint": "This method should only retrieve data and shouldn't modify any data on the server."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is WSGI in Python web development?",
        "options": ["Web Server Gateway Interface", "Web Socket Gateway Integration", "Web Service Global Interface", "Web Server Gateway Integration"],
        "correctOptionIndex": 0,
        "correctOptionText": "Web Server Gateway Interface",
        "difficulty": "medium",
        "explanation": "WSGI (Web Server Gateway Interface) is a specification that describes how a web server communicates with web applications. It's a standard interface between web server software and web applications written in Python.",
        "hint": "It's a specification for a common interface between web servers and Python web applications or frameworks."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "In Flask, which decorator is used to bind a function to a URL pattern?",
        "options": ["@app.url", "@app.route", "@app.path", "@app.bind"],
        "correctOptionIndex": 1,
        "correctOptionText": "@app.route",
        "difficulty": "easy",
        "explanation": "In Flask, the @app.route decorator is used to bind a function to a URL. When a user visits the URL, the function is executed and the return value is shown to the user.",
        "hint": "This decorator maps a URL with a function that will handle the logic for that URL."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What template engine is built into Django by default?",
        "options": ["Jinja2", "Mako", "Django Template Language (DTL)", "Chameleon"],
        "correctOptionIndex": 2,
        "correctOptionText": "Django Template Language (DTL)",
        "difficulty": "medium",
        "explanation": "Django comes with its own template language called the Django Template Language (DTL). It's a powerful and expressive language that allows developers to define the structure of an output document while placeholders allow for dynamic content.",
        "hint": "Django's built-in template system is often abbreviated as DTL."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "Which of the following is NOT a common HTTP status code?",
        "options": ["200 OK", "404 Not Found", "500 Internal Server Error", "600 Server Timeout"],
        "correctOptionIndex": 3,
        "correctOptionText": "600 Server Timeout",
        "difficulty": "medium",
        "explanation": "600 is not a standard HTTP status code. Status codes 600+ are not defined in the HTTP specification. Common status codes include 200 (OK), 404 (Not Found), and 500 (Internal Server Error).",
        "hint": "HTTP status codes are standardized, and some ranges (like 100s, 200s, 300s, 400s, 500s) have specific meanings."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is Django's ORM primarily used for?",
        "options": ["Handling HTTP requests", "Creating database queries using Python code", "Managing static files", "Routing URLs"],
        "correctOptionIndex": 1,
        "correctOptionText": "Creating database queries using Python code",
        "difficulty": "medium",
        "explanation": "Django's ORM (Object-Relational Mapping) allows developers to interact with databases using Python code rather than writing raw SQL queries. It abstracts the database operations so you can work with Python objects instead.",
        "hint": "ORM stands for Object-Relational Mapping, which involves mapping between database tables and application objects."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What package would you use to make HTTP requests in Python?",
        "options": ["http", "requests", "urllib", "httplib"],
        "correctOptionIndex": 1,
        "correctOptionText": "requests",
        "difficulty": "easy",
        "explanation": "The 'requests' library is a popular Python package for making HTTP requests. It abstracts the complexities of making requests behind a simple API so that you can focus on interacting with services and consuming data.",
        "hint": "This library's slogan is 'HTTP for Humans' and it's widely used for its simplicity."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "In Flask, what does the `jsonify()` function do?",
        "options": ["Validates JSON data", "Converts a Python dictionary to a JSON response", "Parses incoming JSON requests", "Encrypts data in JSON format"],
        "correctOptionIndex": 1,
        "correctOptionText": "Converts a Python dictionary to a JSON response",
        "difficulty": "medium",
        "explanation": "Flask's `jsonify()` function converts a Python dictionary to a JSON response. It not only serializes the data to JSON but also sets the appropriate Content-Type header to application/json.",
        "hint": "This function helps in sending JSON responses from your Flask application."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is the purpose of Django migrations?",
        "options": ["To move code between servers", "To update the database schema based on model changes", "To transfer static files to a CDN", "To migrate users between authentication systems"],
        "correctOptionIndex": 1,
        "correctOptionText": "To update the database schema based on model changes",
        "difficulty": "medium",
        "explanation": "Django migrations are a way of propagating changes you make to your models (adding a field, deleting a model, etc.) into your database schema. They allow you to apply model changes to your database without having to manually modify your database schema.",
        "hint": "Migrations help in version controlling and applying changes to your database structure over time."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "Which of the following is a Python-based web crawler and scraping framework?",
        "options": ["BeautifulSoup", "Scrapy", "Selenium", "lxml"],
        "correctOptionIndex": 1,
        "correctOptionText": "Scrapy",
        "difficulty": "medium",
        "explanation": "Scrapy is an open-source and collaborative web crawling framework for Python. It's designed for web scraping and extracting structured data from websites, and can also be used for web crawling.",
        "hint": "This framework is specifically designed for crawling websites and extracting structured data."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is the primary use of FastAPI in Python?",
        "options": ["Data visualization", "Web development framework for building APIs", "Database management", "Machine learning"],
        "correctOptionIndex": 1,
        "correctOptionText": "Web development framework for building APIs",
        "difficulty": "medium",
        "explanation": "FastAPI is a modern, fast (high-performance) web framework for building APIs with Python 3.7+ based on standard Python type hints. It's designed to make it easy to build APIs with automatic validation, serialization, documentation, and more.",
        "hint": "This framework is known for its speed and automatic generation of OpenAPI documentation."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What does CSRF stand for in web security?",
        "options": ["Cross-Site Request Forgery", "Client-Side Request Function", "Cross-Server Resource Framework", "Common Security Response Format"],
        "correctOptionIndex": 0,
        "correctOptionText": "Cross-Site Request Forgery",
        "difficulty": "medium",
        "explanation": "CSRF (Cross-Site Request Forgery) is an attack that forces authenticated users to submit a request to a web application against which they are currently authenticated. Django and other frameworks include protection against CSRF attacks.",
        "hint": "This security vulnerability involves tricking a user into performing actions they didn't intend to do on a website they're authenticated with."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "In Django, what is a 'view'?",
        "options": ["A template file", "A function or method that processes a request and returns a response", "A database table", "A CSS file"],
        "correctOptionIndex": 1,
        "correctOptionText": "A function or method that processes a request and returns a response",
        "difficulty": "easy",
        "explanation": "In Django, a view is a Python function or method that takes a web request and returns a web response. Views are where the logic of your application goes – they access data through models and delegate formatting to templates.",
        "hint": "This is the component that handles the request-response cycle in Django's MVT architecture."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is the purpose of the `requirements.txt` file in a Python web project?",
        "options": ["To list project maintainers", "To specify Python package dependencies", "To define database schemas", "To configure web server settings"],
        "correctOptionIndex": 1,
        "correctOptionText": "To specify Python package dependencies",
        "difficulty": "easy",
        "explanation": "The `requirements.txt` file lists all the Python packages that your project depends on. It enables others to install the exact same versions of the dependencies that you're using, ensuring consistency across different environments.",
        "hint": "This file helps in maintaining consistent package versions across development, testing, and production environments."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is the role of Gunicorn in Python web development?",
        "options": ["A template engine", "A WSGI HTTP server", "A frontend framework", "A database ORM"],
        "correctOptionIndex": 1,
        "correctOptionText": "A WSGI HTTP server",
        "difficulty": "medium",
        "explanation": "Gunicorn ('Green Unicorn') is a Python WSGI HTTP server for UNIX. It's a pre-fork worker model, ported from Ruby's Unicorn project. It's designed to serve Python WSGI applications, such as those built with Flask or Django, in a production environment.",
        "hint": "This component sits between your web application and the web server (like Nginx) in a production setup."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is the purpose of Django's 'middleware'?",
        "options": ["To handle static files", "To process requests and responses globally", "To define URL patterns", "To manage database connections"],
        "correctOptionIndex": 1,
        "correctOptionText": "To process requests and responses globally",
        "difficulty": "hard",
        "explanation": "Django middleware is a framework of hooks into Django's request/response processing. It's a light, low-level plugin system for globally altering Django's input or output. Each middleware component is responsible for doing some specific function, such as adding CSRF protection or handling sessions.",
        "hint": "This component allows you to process every request/response that flows through your Django application."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "Which protocol is WebSocket designed to replace or reduce the need for?",
        "options": ["HTTP", "FTP", "SMTP", "SSH"],
        "correctOptionIndex": 0,
        "correctOptionText": "HTTP",
        "difficulty": "medium",
        "explanation": "WebSocket is designed to reduce the limitations of HTTP polling by providing a standardized way for the server to send content to the client without being solicited by the client. It enables real-time communication between client and server, which HTTP was not originally designed for.",
        "hint": "This protocol enables real-time, two-way communication, reducing the overhead of repeatedly opening connections that is typical in the request-response model."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is the primary benefit of using Flask-RESTful extension?",
        "options": ["Enhanced security features", "Simplified creation of RESTful APIs", "Improved database performance", "Automatic HTML generation"],
        "correctOptionIndex": 1,
        "correctOptionText": "Simplified creation of RESTful APIs",
        "difficulty": "hard",
        "explanation": "Flask-RESTful is an extension for Flask that adds support for quickly building REST APIs. It encourages best practices with minimal setup, providing a coherent way to create APIs with Flask by adding resource-based routing and response handling.",
        "hint": "This extension helps in organizing API endpoints and serializing/deserializing data in a RESTful manner."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What does SQLAlchemy provide in Python web applications?",
        "options": ["Template rendering", "Form validation", "ORM and SQL toolkit", "Caching mechanism"],
        "correctOptionIndex": 2,
        "correctOptionText": "ORM and SQL toolkit",
        "difficulty": "medium",
        "explanation": "SQLAlchemy is a SQL toolkit and Object-Relational Mapping (ORM) library for Python. It provides a full suite of well-known enterprise-level persistence patterns, designed for efficient and high-performing database access.",
        "hint": "This library helps in working with databases using Python objects instead of raw SQL queries."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "In Django, what is the purpose of the 'settings.py' file?",
        "options": ["To define database models", "To create URL patterns", "To configure project settings", "To define view functions"],
        "correctOptionIndex": 2,
        "correctOptionText": "To configure project settings",
        "difficulty": "easy",
        "explanation": "The 'settings.py' file in Django contains all the configuration for your Django project. This includes database configuration, installed apps, middleware settings, template configurations, static file locations, and many other project-wide settings.",
        "hint": "This file is where you'd configure your database connection, debug mode, installed apps, and other global project settings."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is the purpose of Jinja2 in web development?",
        "options": ["Database migration", "Template rendering", "URL routing", "Authentication"],
        "correctOptionIndex": 1,
        "correctOptionText": "Template rendering",
        "difficulty": "medium",
        "explanation": "Jinja2 is a modern and designer-friendly templating language for Python. It's similar to the Django template language but provides Python-like expressions. Flask uses Jinja2 as its template engine by default.",
        "hint": "This tool helps in creating dynamic HTML pages by separating the presentation logic from the application logic."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is GraphQL in the context of web APIs?",
        "options": ["A graph-based database", "A query language for APIs", "A Python web framework", "A network protocol"],
        "correctOptionIndex": 1,
        "correctOptionText": "A query language for APIs",
        "difficulty": "hard",
        "explanation": "GraphQL is a query language for APIs and a runtime for executing those queries with your existing data. It provides a complete and understandable description of the data in your API, gives clients the power to ask for exactly what they need and nothing more.",
        "hint": "This technology allows clients to request exactly the data they need, unlike REST where endpoints return fixed data structures."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What does the term 'MVC' stand for in web development?",
        "options": ["Model-View-Controller", "Multiple-View-Component", "Model-Variable-Connection", "Main-View-Configuration"],
        "correctOptionIndex": 0,
        "correctOptionText": "Model-View-Controller",
        "difficulty": "easy",
        "explanation": "MVC stands for Model-View-Controller, which is an architectural pattern that separates an application into three main logical components: the model (data), the view (user interface), and the controller (processes that handle input). Django follows a similar pattern often called MTV (Model-Template-View).",
        "hint": "This is a design pattern that separates concerns in web applications, particularly the data, user interface, and application logic."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        ...
        "difficulty": "easy",
        "explanation": "HTTP status code 200 (OK) indicates that the request has succeeded. It's the standard response for successful HTTP requests, especially for GET requests.",
        "hint": "This status code is in the 2xx range, which generally indicates success."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is the purpose of the Django REST framework?",
        "options": ["To create machine learning models", "To build RESTful APIs with Django", "To manage database migrations", "To handle websocket connections"],
        "correctOptionIndex": 1,
        "correctOptionText": "To build RESTful APIs with Django",
        "difficulty": "medium",
        "explanation": "Django REST framework is a powerful and flexible toolkit for building Web APIs. It includes features like serialization that can handle both ORM and non-ORM data sources, customizable authentication, and extensive documentation.",
        "hint": "This framework extends Django to make it easier to build web APIs following REST principles."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "Which of the following tools would you use to test a Python web API?",
        "options": ["pytest", "mypy", "black", "pylint"],
        "correctOptionIndex": 0,
        "correctOptionText": "pytest",
        "difficulty": "medium",
        "explanation": "pytest is a testing framework that makes it easy to write small, readable tests, and can scale to support complex functional testing for applications and libraries. It's commonly used to test Python web applications and APIs.",
        "hint": "This tool is specifically designed for writing and running tests in Python."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is ASGI in Python web development?",
        "options": ["Asynchronous Server Gateway Interface", "Advanced System Gateway Interface", "Apache Server Gateway Interface", "Application Server Gateway Interface"],
        "correctOptionIndex": 0,
        "correctOptionText": "Asynchronous Server Gateway Interface",
        "difficulty": "hard",
        "explanation": "ASGI (Asynchronous Server Gateway Interface) is a spiritual successor to WSGI, intended to provide a standard interface between async-capable Python web servers, frameworks, and applications. It allows for handling WebSockets, HTTP/2, and other protocols that require long-lived connections.",
        "hint": "This specification was designed to handle asynchronous connections in Python web applications, unlike its predecessor which was primarily synchronous."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "What is the main role of Celery in Python web applications?",
        "options": ["Front-end rendering", "Database management", "Asynchronous task processing", "API documentation"],
        "correctOptionIndex": 2,
        "correctOptionText": "Asynchronous task processing",
        "difficulty": "hard",
        "explanation": "Celery is an asynchronous task queue/job queue based on distributed message passing. It's focused on real-time operation but supports scheduling as well. It's commonly used to run background tasks in Python web applications, particularly for tasks that are time-consuming or need to be run at regular intervals.",
        "hint": "This tool helps in executing code asynchronously, outside the HTTP request-response cycle."
    },
    {
        "topic": "67d6b45a953bd3a26da2ad85",
        "module": "Web Development with Python",
        "questionText": "Which of the following is NOT typically a component of a RESTful API URL?",
        "options": ["Resource identifier", "HTTP method", "Query parameters", "API version"],
        "correctOptionIndex": 1,
        "correctOptionText": "HTTP method",
        "difficulty": "hard",
        "explanation": "HTTP methods (GET, POST, PUT, DELETE) are not part of the URL in RESTful APIs. Instead, they are specified in the HTTP request header. The URL typically contains the resource identifier, possibly query parameters, and sometimes the API version, but not the HTTP method itself.",
        "hint": "This component is sent in the HTTP request header rather than being part of the URL."
    },
